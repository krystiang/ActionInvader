...
var $is_Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgValue)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgValue(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgValue"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgValue = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgValue)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgValue = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgValue(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgValue;", depth))
});
var $is_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer)))
});
var $as_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.InternalSingleClassDeserializer"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.InternalSingleClassDeserializer;", depth))
});
var $is_Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingResult)))
});
var $as_Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_util_ParsingResult(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.util.ParsingResult"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingResult)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingResult(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.util.ParsingResult;", depth))
});
/** @constructor */
var $c_O = (function() {
  /*<skip>*/
...
var $d_scm_HashEntry = new $ClassTypeData({
  scm_HashEntry: 0
}, true, "scala.collection.mutable.HashEntry", {
  scm_HashEntry: 1
});
/** @constructor */
var $c_Lnet_devsupport_framework_JsFramework = (function() {
  $c_O.call(this);
  this.net$devsupport$framework$JsFramework$$ws$1 = null;
  this.net$devsupport$framework$JsFramework$$open$1 = false;
  this.net$devsupport$framework$JsFramework$$stash$1 = null;
  this.subscribtions$1 = null
});
$c_Lnet_devsupport_framework_JsFramework.prototype = new $h_O();
$c_Lnet_devsupport_framework_JsFramework.prototype.constructor = $c_Lnet_devsupport_framework_JsFramework;
/** @constructor */
var $h_Lnet_devsupport_framework_JsFramework = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_framework_JsFramework.prototype = $c_Lnet_devsupport_framework_JsFramework.prototype;
$c_Lnet_devsupport_framework_JsFramework.prototype.$$js$exported$meth$subscribe__T__sjs_js_Function1__O = (function(groupName, f) {
  this.subscribe__T__sjs_js_Function1__V(groupName, f)
});
$c_Lnet_devsupport_framework_JsFramework.prototype.net$devsupport$framework$JsFramework$$handleWebsocketMsg__T__V = (function(s) {
  var rc8 = false;
  var x2 = null;
  var x1 = $m_Lnet_devsupport_messaging_json_NativeJsonParser$().parse__T__Lnet_devsupport_messaging_serialization_util_ParsingResult(s);
  matchEnd9: {
    if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1)) {
      rc8 = true;
      x2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1);
      var msgObj = $as_Lnet_devsupport_messaging_format_package$MsgValue(x2.value$1);
      if ($is_Lnet_devsupport_messaging_format_package$MsgObject(msgObj)) {
        var x5 = ((msgObj === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(msgObj).value$1);
        var this$1 = $m_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$().WebsocketGroupsDeserializer$1;
        var x1$2 = $s_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$class__deserialize__Lnet_devsupport_serialization_macros_impl_MacroDeserializer__sci_Map__Lnet_devsupport_messaging_serialization_util_ParsingResult(this$1, x5);
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1$2)) {
          var x2$2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1$2);
          var value = $as_Lnet_devsupport_messaging_Envelope(x2$2.value$1);
          if ((value !== null)) {
            var p2 = value.msg$1;
            if ($is_Lnet_devsupport_middleware_groups_websocket_api_Publish(p2)) {
              var x4 = $as_Lnet_devsupport_middleware_groups_websocket_api_Publish(p2);
              var group = x4.group$1;
              var msg = x4.msg$1;
              var this$3 = $m_s_Console$();
              var this$4 = this$3.outVar$2;
              var this$5 = $as_Ljava_io_PrintStream(this$4.tl$1.get__O());
              this$5.printString__p4__T__V((((("(" + "handle") + ",") + value) + ")"));
              this$5.printString__p4__T__V("\n");
              var json = $g["JSON"]["parse"](msg);
              var this$7 = this.subscribtions$1.get__O__s_Option(group);
        ...
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(x1$2)) {
          var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(x1$2);
          if (((x3.errors$1 !== null) && (x3.errors$1.lengthCompare__I__I(1) === 0))) {
            break matchEnd9
          }
        };
    ...
    if (rc8) {
      var msgObj$2 = $as_Lnet_devsupport_messaging_format_package$MsgValue(x2.value$1);
      if ((msgObj$2 !== null)) {
        break matchEnd9
      }
    };
    if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(x1)) {
      var x4$2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(x1);
      if (((x4$2.errors$1 !== null) && (x4$2.errors$1.lengthCompare__I__I(1) === 0))) {
        break matchEnd9
      }
    };
...
$c_Lnet_devsupport_framework_JsFramework.prototype.serialize__p1__O__Lnet_devsupport_messaging_serialization_Serializer__T = (function(msg, evidence$2) {
  var m = evidence$2.serialize__O__sci_Map(msg);
  return $m_Lnet_devsupport_messaging_json_NativeJsonRenderer$().stringify__Lnet_devsupport_messaging_format_package$MsgValue__T(new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(m))
});
$c_Lnet_devsupport_framework_JsFramework.prototype.$$js$exported$meth$publish__T__sjs_js_Object__O = (function(groupName, msg) {
  this.publish__T__sjs_js_Object__V(groupName, msg)
});
$c_Lnet_devsupport_framework_JsFramework.prototype.init___T = (function(ip) {
  this.net$devsupport$framework$JsFramework$$ws$1 = new $g["WebSocket"](ip);
  this.net$devsupport$framework$JsFramework$$open$1 = false;
  this.net$devsupport$framework$JsFramework$$stash$1 = ($m_sci_List$(), $m_sci_Nil$());
  this.net$devsupport$framework$JsFramework$$ws$1["onmessage"] = (function(arg$outer) {
    return (function(msg$2) {
      arg$outer.net$devsupport$framework$JsFramework$$handleWebsocketMsg__T__V($objectToString(msg$2["data"]))
    })
  })(this);
  this.net$devsupport$framework$JsFramework$$ws$1["onopen"] = (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lnet_devsupport_framework_JsFramework$$anonfun$2().init___Lnet_devsupport_framework_JsFramework(this));
  this.net$devsupport$framework$JsFramework$$ws$1["onclose"] = (function(arg$outer$1) {
    return (function(e$2) {
      var this$3 = $m_s_Console$();
      var this$4 = this$3.outVar$2;
      var this$5 = $as_Ljava_io_PrintStream(this$4.tl$1.get__O());
      this$5.printString__p4__T__V((((("(" + "onclose") + ",") + e$2) + ")"));
      this$5.printString__p4__T__V("\n");
      arg$outer$1.net$devsupport$framework$JsFramework$$open$1 = false
    })
  })(this);
  this.subscribtions$1 = new $c_scm_HashMap().init___();
  return this
});
$c_Lnet_devsupport_framework_JsFramework.prototype.publish__T__sjs_js_Object__V = (function(groupName, msg) {
  this.send__p1__O__Lnet_devsupport_messaging_serialization_Serializer__V(new $c_Lnet_devsupport_middleware_groups_websocket_api_Publish().init___T__T(groupName, $as_T($g["JSON"]["stringify"](msg))), $m_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$().PublishFormat$1)
});
$c_Lnet_devsupport_framework_JsFramework.prototype.subscribe__T__sjs_js_Function1__V = (function(groupName, f) {
  this.send__p1__O__Lnet_devsupport_messaging_serialization_Serializer__V(new $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe().init___T(groupName), $m_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$().SubscribeFormat$1);
  this.subscribtions$1.$$plus$eq__T2__scm_MapLike(new $c_T2().init___O__O(groupName, f))
});
$c_Lnet_devsupport_framework_JsFramework.prototype.send__p1__O__Lnet_devsupport_messaging_serialization_Serializer__V = (function(msg, evidence$1) {
  if (this.net$devsupport$framework$JsFramework$$open$1) {
    var jsx$1 = this.net$devsupport$framework$JsFramework$$ws$1;
    var s = this.serialize__p1__O__Lnet_devsupport_messaging_serialization_Serializer__T(msg, evidence$1);
    jsx$1["send"](s)
  } else {
    var this$3 = this.net$devsupport$framework$JsFramework$$stash$1;
    var elem = this.serialize__p1__O__Lnet_devsupport_messaging_serialization_Serializer__T(msg, evidence$1);
    var this$2 = $m_sci_List$();
    var bf = this$2.ReusableCBFInstance$2;
    this.net$devsupport$framework$JsFramework$$stash$1 = $as_sci_List($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$3, elem, bf))
  }
});
$c_Lnet_devsupport_framework_JsFramework.prototype["publish"] = (function(arg$1, arg$2) {
  var preparg$1 = $as_T(arg$1);
  var preparg$2 = arg$2;
  return this.$$js$exported$meth$publish__T__sjs_js_Object__O(preparg$1, preparg$2)
});
$c_Lnet_devsupport_framework_JsFramework.prototype["subscribe"] = (function(arg$1, arg$2) {
  var preparg$1 = $as_T(arg$1);
  var preparg$2 = arg$2;
  return this.$$js$exported$meth$subscribe__T__sjs_js_Function1__O(preparg$1, preparg$2)
});
var $d_Lnet_devsupport_framework_JsFramework = new $ClassTypeData({
  Lnet_devsupport_framework_JsFramework: 0
}, false, "net.devsupport.framework.JsFramework", {
  Lnet_devsupport_framework_JsFramework: 1,
  O: 1
});
$c_Lnet_devsupport_framework_JsFramework.prototype.$classData = $d_Lnet_devsupport_framework_JsFramework;
$e["net"] = ($e["net"] || {});
$e["net"]["devsupport"] = ($e["net"]["devsupport"] || {});
$e["net"]["devsupport"]["framework"] = ($e["net"]["devsupport"]["framework"] || {});
/** @constructor */
$e["net"]["devsupport"]["framework"]["JsFramework"] = (function(arg$1) {
  $c_Lnet_devsupport_framework_JsFramework.call(this);
  var preparg$1 = $as_T(arg$1);
  $c_Lnet_devsupport_framework_JsFramework.prototype.init___T.call(this, preparg$1)
});
$e["net"]["devsupport"]["framework"]["JsFramework"].prototype = $c_Lnet_devsupport_framework_JsFramework.prototype;
var $is_Lnet_devsupport_messaging_serialization_Serializer = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_Serializer)))
});
var $as_Lnet_devsupport_messaging_serialization_Serializer = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_Serializer(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.Serializer"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_Serializer = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_Serializer)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_Serializer = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_Serializer(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.Serializer;", depth))
});
var $is_Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_SingleClassDeserializer)))
});
var $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.SingleClassDeserializer"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_SingleClassDeserializer)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.SingleClassDeserializer;", depth))
});
var $s_Lnet_devsupport_messaging_serialization_util_ParsingResult$class__map__Lnet_devsupport_messaging_serialization_util_ParsingResult__F1__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function($$this, f) {
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess($$this)) {
    var x2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess($$this);
    var v = x2.value$1;
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(f.apply__O__O(v))
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError($$this)) {
    var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError($$this);
    return x3
  } else {
    throw new $c_s_MatchError().init___O($$this)
  }
});
var $s_Lnet_devsupport_messaging_serialization_util_ParsingResult$class__flatMap__Lnet_devsupport_messaging_serialization_util_ParsingResult__F1__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function($$this, f) {
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess($$this)) {
    var x2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess($$this);
    var v = x2.value$1;
    return $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(f.apply__O__O(v))
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError($$this)) {
    var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError($$this);
    return x3
  } else {
...
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$ = (function() {
  $c_O.call(this);
  this.functionalCanBuildSerializer$1 = null;
  this.contravariantFunctorSerializer$1 = null;
  this.applicativeParsingResult$1 = null
});
$c_Lnet_devsupport_serialization_macros_builders_package$.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$.prototype.init___ = (function() {
  $n_Lnet_devsupport_serialization_macros_builders_package$ = this;
  this.functionalCanBuildSerializer$1 = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$6().init___();
  this.contravariantFunctorSerializer$1 = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$2().init___();
  this.applicativeParsingResult$1 = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$7().init___();
  return this
});
var $d_Lnet_devsupport_serialization_macros_builders_package$ = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$: 0
}, false, "net.devsupport.serialization.macros.builders.package$", {
  Lnet_devsupport_serialization_macros_builders_package$: 1,
  O: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$;
var $n_Lnet_devsupport_serialization_macros_builders_package$ = (void 0);
var $m_Lnet_devsupport_serialization_macros_builders_package$ = (function() {
  if ((!$n_Lnet_devsupport_serialization_macros_builders_package$)) {
    $n_Lnet_devsupport_serialization_macros_builders_package$ = new $c_Lnet_devsupport_serialization_macros_builders_package$().init___()
  };
  return $n_Lnet_devsupport_serialization_macros_builders_package$
});
var $s_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$class__deserialize__Lnet_devsupport_serialization_macros_impl_MacroDeserializer__sci_Map__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function($$this, msg) {
  var x1 = msg.get__O__s_Option("tpe");
  matchEnd6: {
    var jsx$1;
    if ($is_s_Some(x1)) {
      var x2 = $as_s_Some(x1);
      var p3 = $as_Lnet_devsupport_messaging_format_package$MsgValue(x2.x$2);
      if ($is_Lnet_devsupport_messaging_format_package$MsgString(p3)) {
        var x4 = ((p3 === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgString(p3).value$1);
        var jsx$1 = new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(x4);
        break matchEnd6
      }
    };
    var jsx$1 = new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["No typehint found"]));
    break matchEnd6
  };
  var this$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(jsx$1);
  var f = new $c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1().init___Lnet_devsupport_serialization_macros_impl_MacroDeserializer__sci_Map($$this, msg);
  return $s_Lnet_devsupport_messaging_serialization_util_ParsingResult$class__flatMap__Lnet_devsupport_messaging_serialization_util_ParsingResult__F1__Lnet_devsupport_messaging_serialization_util_ParsingResult(this$1, f)
});
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = (function() {
  $c_O.call(this);
  this.HeaderField$1 = null;
  this.TypeField$1 = null;
  this.emptySerializer$1 = null;
  this.headerDeserializer$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype;
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype.init___ = (function() {
  $n_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = this;
  this.HeaderField$1 = "header";
  this.TypeField$1 = "tpe";
  this.emptySerializer$1 = new $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1().init___();
  this.headerDeserializer$1 = new $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3().init___();
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype.extractHeader__sci_Map__Lnet_devsupport_messaging_Header = (function(msg) {
  var this$1 = msg.get__O__s_Option(this.HeaderField$1);
  if (this$1.isEmpty__Z()) {
    var this$2 = $m_s_None$()
  } else {
    var arg1 = this$1.get__O();
    var v = $as_Lnet_devsupport_messaging_format_package$MsgValue(arg1);
    var m = ((v === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(v).value$1);
    var this$2 = new $c_s_Some().init___O(new $c_T2().init___O__O(v, new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(m)))
  };
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_T2(x$1$2);
    if ((x$1 !== null)) {
      var m$1 = $as_Lnet_devsupport_messaging_format_package$MsgObject(x$1.$$und2$f).value$1;
      new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(m$1);
      return true
    } else {
      throw new $c_s_MatchError().init___O(x$1)
    }
  }));
  var this$3 = new $c_s_Option$WithFilter().init___s_Option__F1(this$2, p);
  var this$4 = this$3.$$outer$f;
  var p$1 = this$3.p$1;
  var this$5 = ((this$4.isEmpty__Z() || $uZ(p$1.apply__O__O(this$4.get__O()))) ? this$4 : $m_s_None$());
  if (this$5.isEmpty__Z()) {
    ...
    var x$2 = $as_T2(v1);
    if ((x$2 !== null)) {
      var m$2 = $as_Lnet_devsupport_messaging_format_package$MsgObject(x$2.$$und2$f).value$1;
      var x1$2 = $m_Lnet_devsupport_serialization_macros_impl_SerializationMacros$().headerDeserializer$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(m$2));
      matchEnd6: {
        var this$6;
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1$2)) {
          var x2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x1$2);
          var x = $as_Lnet_devsupport_messaging_Header(x2.value$1);
          var this$6 = new $c_s_Some().init___O(x);
          break matchEnd6
        };
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(x1$2)) {
          var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(x1$2);
      ...
      if (this$6.isEmpty__Z()) {
        ...
        var this$7 = new $c_s_Some().init___O($as_Lnet_devsupport_messaging_Header(arg1$1))
      }
    } else {
      var this$7;
  ...
  return $as_Lnet_devsupport_messaging_Header((this$7.isEmpty__Z() ? $m_Lnet_devsupport_messaging_EmptyHeader$() : this$7.get__O()))
});
var $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$: 0
}, false, "net.devsupport.serialization.macros.impl.SerializationMacros$", {
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$: 1,
  O: 1
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$;
var $n_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = (void 0);
var $m_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = (function() {
  if ((!$n_Lnet_devsupport_serialization_macros_impl_SerializationMacros$)) {
    $n_Lnet_devsupport_serialization_macros_impl_SerializationMacros$ = new $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$().init___()
  };
  return $n_Lnet_devsupport_serialization_macros_impl_SerializationMacros$
});
/** @constructor */
var $c_Lplay_api_libs_functional_ContravariantFunctorOps = (function() {
  $c_O.call(this);
  this.ma$1 = null;
  this.fu$1 = null
});
$c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype = new $h_O();
$c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype.constructor = $c_Lplay_api_libs_functional_ContravariantFunctorOps;
/** @constructor */
var $h_Lplay_api_libs_functional_ContravariantFunctorOps = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_ContravariantFunctorOps.prototype = $c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype;
$c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype.init___O__Lplay_api_libs_functional_ContravariantFunctor = (function(ma, fu) {
  this.ma$1 = ma;
  this.fu$1 = fu;
  return this
});
$c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype.contramap__F1__O = (function(f) {
  var this$1 = this.fu$1;
  var m = this.ma$1;
  return this$1.contramap__Lnet_devsupport_messaging_serialization_Serializer__F1__Lnet_devsupport_messaging_serialization_Serializer($as_Lnet_devsupport_messaging_serialization_Serializer(m), f)
});
var $d_Lplay_api_libs_functional_ContravariantFunctorOps = new $ClassTypeData({
  Lplay_api_libs_functional_ContravariantFunctorOps: 0
}, false, "play.api.libs.functional.ContravariantFunctorOps", {
  Lplay_api_libs_functional_ContravariantFunctorOps: 1,
  O: 1
});
$c_Lplay_api_libs_functional_ContravariantFunctorOps.prototype.$classData = $d_Lplay_api_libs_functional_ContravariantFunctorOps;
/** @constructor */
var $c_Lplay_api_libs_functional_FunctionalBuilder = (function() {
  $c_O.call(this);
  this.play$api$libs$functional$FunctionalBuilder$$canBuild$f = null
});
$c_Lplay_api_libs_functional_FunctionalBuilder.prototype = new $h_O();
$c_Lplay_api_libs_functional_FunctionalBuilder.prototype.constructor = $c_Lplay_api_libs_functional_FunctionalBuilder;
/** @constructor */
var $h_Lplay_api_libs_functional_FunctionalBuilder = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_FunctionalBuilder.prototype = $c_Lplay_api_libs_functional_FunctionalBuilder.prototype;
$c_Lplay_api_libs_functional_FunctionalBuilder.prototype.init___Lplay_api_libs_functional_FunctionalCanBuild = (function(canBuild) {
  this.play$api$libs$functional$FunctionalBuilder$$canBuild$f = canBuild;
  return this
});
var $d_Lplay_api_libs_functional_FunctionalBuilder = new $ClassTypeData({
  Lplay_api_libs_functional_FunctionalBuilder: 0
}, false, "play.api.libs.functional.FunctionalBuilder", {
  Lplay_api_libs_functional_FunctionalBuilder: 1,
  O: 1
});
$c_Lplay_api_libs_functional_FunctionalBuilder.prototype.$classData = $d_Lplay_api_libs_functional_FunctionalBuilder;
/** @constructor */
var $c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2 = (function() {
  $c_O.call(this);
  this.m1$1 = null;
  this.m2$1 = null;
  this.$$outer$f = null
});
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype = new $h_O();
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype.constructor = $c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2;
/** @constructor */
var $h_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2 = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype = $c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype;
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype.apply__F2__Lplay_api_libs_functional_Functor__O = (function(f, fu) {
  var m = this.$$outer$f.play$api$libs$functional$FunctionalBuilder$$canBuild$f.apply__O__O__O(this.m1$1, this.m2$1);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$1) {
    return (function(x0$1$2) {
      var x0$1 = $as_Lplay_api_libs_functional_$tilde(x0$1$2);
      if ((x0$1 !== null)) {
        var a1 = x0$1.$$und1$1;
        var a2 = x0$1.$$und2$1;
        return f$1.apply__O__O__O(a1, a2)
      } else {
        throw new $c_s_MatchError().init___O(x0$1)
      }
    })
  })(f));
  return fu.fmap__Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(m), f$2)
});
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype.apply__F1__Lplay_api_libs_functional_ContravariantFunctor__O = (function(f, fu) {
  var m = this.$$outer$f.play$api$libs$functional$FunctionalBuilder$$canBuild$f.apply__O__O__O(this.m1$1, this.m2$1);
  var f1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$2) {
    return (function(b$2) {
      var x1 = $as_T2(f$2.apply__O__O(b$2));
      if ((x1 !== null)) {
        var a1 = x1.$$und1$f;
        var a2 = x1.$$und2$f;
        var x$1_$_$$und1$f = a1;
        var x$1_$_$$und2$f = a2
      } else {
        var x$1_$_$$und1$f;
        var x$1_$_$$und2$f;
        throw new $c_s_MatchError().init___O(x1)
      };
      var a1$2 = x$1_$_$$und1$f;
      var a2$2 = x$1_$_$$und2$f;
      return new $c_Lplay_api_libs_functional_$tilde().init___O__O(a1$2, a2$2)
    })
  })(f));
  return fu.contramap__Lnet_devsupport_messaging_serialization_Serializer__F1__Lnet_devsupport_messaging_serialization_Serializer($as_Lnet_devsupport_messaging_serialization_Serializer(m), f1)
});
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype.init___Lplay_api_libs_functional_FunctionalBuilder__O__O = (function($$outer, m1, m2) {
  this.m1$1 = m1;
  this.m2$1 = m2;
  if (($$outer === null)) {
...
var $d_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2 = new $ClassTypeData({
  Lplay_api_libs_functional_FunctionalBuilder$CanBuild2: 0
}, false, "play.api.libs.functional.FunctionalBuilder$CanBuild2", {
  Lplay_api_libs_functional_FunctionalBuilder$CanBuild2: 1,
  O: 1
});
$c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2.prototype.$classData = $d_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2;
/** @constructor */
var $c_Lplay_api_libs_functional_FunctionalBuilderOps = (function() {
  $c_O.call(this);
  this.ma$1 = null;
  this.fcb$1 = null
});
$c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype = new $h_O();
$c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype.constructor = $c_Lplay_api_libs_functional_FunctionalBuilderOps;
/** @constructor */
var $h_Lplay_api_libs_functional_FunctionalBuilderOps = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_FunctionalBuilderOps.prototype = $c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype;
$c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype.$$tilde__O__Lplay_api_libs_functional_FunctionalBuilder$CanBuild2 = (function(mb) {
  var b = new $c_Lplay_api_libs_functional_FunctionalBuilder().init___Lplay_api_libs_functional_FunctionalCanBuild(this.fcb$1);
  return new $c_Lplay_api_libs_functional_FunctionalBuilder$CanBuild2().init___Lplay_api_libs_functional_FunctionalBuilder__O__O(b, this.ma$1, mb)
});
$c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype.init___O__Lplay_api_libs_functional_FunctionalCanBuild = (function(ma, fcb) {
  this.ma$1 = ma;
  this.fcb$1 = fcb;
  return this
});
var $d_Lplay_api_libs_functional_FunctionalBuilderOps = new $ClassTypeData({
  Lplay_api_libs_functional_FunctionalBuilderOps: 0
}, false, "play.api.libs.functional.FunctionalBuilderOps", {
  Lplay_api_libs_functional_FunctionalBuilderOps: 1,
  O: 1
});
$c_Lplay_api_libs_functional_FunctionalBuilderOps.prototype.$classData = $d_Lplay_api_libs_functional_FunctionalBuilderOps;
/** @constructor */
...
/** @constructor */
var $c_s_Option$WithFilter = (function() {
  $c_O.call(this);
  this.p$1 = null;
  this.$$outer$f = null
});
...
/** @constructor */
var $h_s_Option$WithFilter = (function() {
  /*<skip>*/
});
...
var $d_s_Option$WithFilter = new $ClassTypeData({
...
$c_s_PartialFunction$.prototype.unlifted__F1__s_PartialFunction = (function(f) {
  if ($is_s_PartialFunction$Lifted(f)) {
    var x2 = $as_s_PartialFunction$Lifted(f);
    return x2.pf__s_PartialFunction()
  } else {
    return new $c_s_PartialFunction$Unlifted().init___F1(f)
  }
});
...
var $s_sci_MapLike$class__$$plus$plus__sci_MapLike__sc_GenTraversableOnce__sci_Map = (function($$this, xs) {
...
/** @constructor */
var $c_Lnet_devsupport_messaging_json_NativeJsonParser$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype.constructor = $c_Lnet_devsupport_messaging_json_NativeJsonParser$;
/** @constructor */
var $h_Lnet_devsupport_messaging_json_NativeJsonParser$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype = $c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype;
$c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype.parse__T__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(in$2) {
  try {
    var parsed = $g["JSON"]["parse"](in$2);
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(this.net$devsupport$messaging$json$NativeJsonParser$$readJs__O__Lnet_devsupport_messaging_format_package$MsgValue(parsed))
  } catch (e) {
    var e$2 = $m_sjsr_package$().wrapJavaScriptException__O__jl_Throwable(e);
    if ((e$2 !== null)) {
      if ($is_sjs_js_JavaScriptException(e$2)) {
        ...
        if ($uZ((e$3 instanceof $g["SyntaxError"]))) {
          return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T(e$3["message"])]))
        }
      };
      throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(e$2)
    } else {
...
$c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype.net$devsupport$messaging$json$NativeJsonParser$$readJs__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(value) {
  if ($is_T(value)) {
    var x2 = $as_T(value);
    return new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T(x2)
  } else if ($is_sjsr_RuntimeLong(value)) {
    var x3 = $uJ(value);
    return new $c_Lnet_devsupport_messaging_format_package$MsgLong().init___J(x3)
  } else if (((typeof value) === "number")) {
    var x4 = $uD(value);
    return new $c_Lnet_devsupport_messaging_format_package$MsgNumber().init___D(x4)
  } else if ($m_sr_BoxesRunTime$().equals__O__O__Z(true, value)) {
    return $m_Lnet_devsupport_messaging_format_package$MsgTrue$()
  } else if ($m_sr_BoxesRunTime$().equals__O__O__Z(false, value)) {
    return $m_Lnet_devsupport_messaging_format_package$MsgFalse$()
  } else if ((value === null)) {
    return $m_Lnet_devsupport_messaging_format_package$MsgNull$()
    ...
    while ((i < len)) {
      ...
      var elem = $m_Lnet_devsupport_messaging_json_NativeJsonParser$().net$devsupport$messaging$json$NativeJsonParser$$readJs__O__Lnet_devsupport_messaging_format_package$MsgValue(arg1);
      array["push"](elem);
      i = ((1 + i) | 0)
    };
    return new $c_Lnet_devsupport_messaging_format_package$MsgArray().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array))
    ...
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(value$2) {
      return $m_Lnet_devsupport_messaging_json_NativeJsonParser$().net$devsupport$messaging$json$NativeJsonParser$$readJs__O__Lnet_devsupport_messaging_format_package$MsgValue(value$2)
    }));
    var this$6 = new $c_sc_MapLike$MappedValues().init___sc_MapLike__F1(this$5, f);
    var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
    return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map($s_sc_TraversableOnce$class__toMap__sc_TraversableOnce__s_Predef$$less$colon$less__sci_Map(this$6, ev))
  } else {
    throw new $c_s_MatchError().init___O(value)
  }
});
var $d_Lnet_devsupport_messaging_json_NativeJsonParser$ = new $ClassTypeData({
  Lnet_devsupport_messaging_json_NativeJsonParser$: 0
}, false, "net.devsupport.messaging.json.NativeJsonParser$", {
  Lnet_devsupport_messaging_json_NativeJsonParser$: 1,
  O: 1,
  Lnet_devsupport_messaging_json_JsonParser: 1
});
$c_Lnet_devsupport_messaging_json_NativeJsonParser$.prototype.$classData = $d_Lnet_devsupport_messaging_json_NativeJsonParser$;
var $n_Lnet_devsupport_messaging_json_NativeJsonParser$ = (void 0);
var $m_Lnet_devsupport_messaging_json_NativeJsonParser$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_json_NativeJsonParser$)) {
    $n_Lnet_devsupport_messaging_json_NativeJsonParser$ = new $c_Lnet_devsupport_messaging_json_NativeJsonParser$().init___()
  };
  return $n_Lnet_devsupport_messaging_json_NativeJsonParser$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype.constructor = $c_Lnet_devsupport_messaging_json_NativeJsonRenderer$;
/** @constructor */
var $h_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype = $c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype;
$c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype.net$devsupport$messaging$json$NativeJsonRenderer$$writeJs__Lnet_devsupport_messaging_format_package$MsgValue__sjs_js_Any = (function(value) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgString(value)) {
    var x2 = ((value === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgString(value).value$1);
    return x2
  } else if ($is_Lnet_devsupport_messaging_format_package$MsgLong(value)) {
    var x3 = $as_Lnet_devsupport_messaging_format_package$MsgLong(value).value$1;
    return x3.toDouble__D()
  } else if ($is_Lnet_devsupport_messaging_format_package$MsgNumber(value)) {
    var x4 = $as_Lnet_devsupport_messaging_format_package$MsgNumber(value).value$1;
    return x4
  } else {
    var x = $m_Lnet_devsupport_messaging_format_package$MsgTrue$();
    if ((x === value)) {
      return true
    } else {
      var x$3 = $m_Lnet_devsupport_messaging_format_package$MsgFalse$();
      if ((x$3 === value)) {
        return false
      } else {
        var x$5 = $m_Lnet_devsupport_messaging_format_package$MsgNull$();
        if ((x$5 === value)) {
          return null
        } else if ($is_Lnet_devsupport_messaging_format_package$MsgArray(value)) {
          var x5 = ((value === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgArray(value).value$1);
          var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(value$2) {
            var value$1 = $as_Lnet_devsupport_messaging_format_package$MsgValue(value$2);
            return $m_Lnet_devsupport_messaging_json_NativeJsonRenderer$().net$devsupport$messaging$json$NativeJsonRenderer$$writeJs__Lnet_devsupport_messaging_format_package$MsgValue__sjs_js_Any(value$1)
          }));
          var this$6 = $m_sc_Seq$();
          return [$as_sc_Seq(x5.map__F1__scg_CanBuildFrom__O(jsx$1, this$6.ReusableCBFInstance$2))]
        } else if ($is_Lnet_devsupport_messaging_format_package$MsgObject(value)) {
          var x6 = ((value === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(value).value$1);
          var jsx$2 = $m_sjs_js_Dictionary$();
          var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(value$2$1) {
            var value$3 = $as_Lnet_devsupport_messaging_format_package$MsgValue(value$2$1);
            return $m_Lnet_devsupport_messaging_json_NativeJsonRenderer$().net$devsupport$messaging$json$NativeJsonRenderer$$writeJs__Lnet_devsupport_messaging_format_package$MsgValue__sjs_js_Any(value$3)
          }));
          var this$7 = new $c_sci_MapLike$$anon$2().init___sci_MapLike__F1(x6, f);
          return jsx$2.apply__sc_Seq__sjs_js_Dictionary($s_sc_MapLike$class__toBuffer__sc_MapLike__scm_Buffer(this$7))
        } else {
          throw new $c_s_MatchError().init___O(value)
        }
      }
...
$c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype.stringify__Lnet_devsupport_messaging_format_package$MsgValue__T = (function(msg) {
  return $as_T($g["JSON"]["stringify"](this.net$devsupport$messaging$json$NativeJsonRenderer$$writeJs__Lnet_devsupport_messaging_format_package$MsgValue__sjs_js_Any(msg)))
});
var $d_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = new $ClassTypeData({
  Lnet_devsupport_messaging_json_NativeJsonRenderer$: 0
}, false, "net.devsupport.messaging.json.NativeJsonRenderer$", {
  Lnet_devsupport_messaging_json_NativeJsonRenderer$: 1,
  O: 1,
  Lnet_devsupport_messaging_json_JsonRenderer: 1
});
$c_Lnet_devsupport_messaging_json_NativeJsonRenderer$.prototype.$classData = $d_Lnet_devsupport_messaging_json_NativeJsonRenderer$;
var $n_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = (void 0);
var $m_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_json_NativeJsonRenderer$)) {
    $n_Lnet_devsupport_messaging_json_NativeJsonRenderer$ = new $c_Lnet_devsupport_messaging_json_NativeJsonRenderer$().init___()
  };
  return $n_Lnet_devsupport_messaging_json_NativeJsonRenderer$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7 = (function() {
  $c_O.call(this);
  this.scd$5$f = null
});
$c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype = $c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype;
$c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgObject(msg)) {
    var x2 = ((msg === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(msg).value$1);
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
      return (function(obj$2) {
        var obj = $as_Lnet_devsupport_messaging_format_package$MsgValue(obj$2);
        return arg$outer.scd$5$f.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(obj)
      })
    })(this));
    var this$7 = new $c_sci_MapLike$$anon$2().init___sci_MapLike__F1(x2, f);
    var z = new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O($m_sci_Map$EmptyMap$());
    var op = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(x0$5$2, x1$5$2) {
      var x0$5 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x0$5$2);
      var x1$5 = $as_T2(x1$5$2);
      var x1 = new $c_T2().init___O__O(x0$5, x1$5);
      var acc = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und1$f);
      var p2 = $as_T2(x1.$$und2$f);
      if ((p2 !== null)) {
        var k = $as_T(p2.$$und1$f);
        var v = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(p2.$$und2$f);
        var x1$2 = new $c_T2().init___O__O(acc, v);
        var p2$2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und1$f);
        var p3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und2$f);
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p2$2)) {
          var x4 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p2$2);
          var x = $as_sci_Map(x4.value$1);
          if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p3)) {
            var x5 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p3);
            var y = x5.value$1;
            return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(x.$$plus__T2__sci_Map(new $c_T2().init___O__O(k, y)))
          }
        };
        var p6 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und1$f);
        var p7 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und2$f);
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p6)) {
          var x8 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p6);
          if (((x8.errors$1 !== null) && (x8.errors$1.lengthCompare__I__I(1) === 0))) {
            var x$2 = $as_T(x8.errors$1.apply__I__O(0));
            if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p7)) {
              return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([x$2]))
            }
          }
        };
        var p10 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und1$f);
        var p11 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und2$f);
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p10)) {
          if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p11)) {
            var x13 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p11);
            if (((x13.errors$1 !== null) && (x13.errors$1.lengthCompare__I__I(1) === 0))) {
              var y$2 = $as_T(x13.errors$1.apply__I__O(0));
              return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([y$2]))
            }
          }
        };
        var p14 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und1$f);
        var p15 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1$2.$$und2$f);
        if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p14)) {
          var x16 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p14);
          if (((x16.errors$1 !== null) && (x16.errors$1.lengthCompare__I__I(1) === 0))) {
            var x$3 = $as_T(x16.errors$1.apply__I__O(0));
            if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p15)) {
              var x17 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p15);
              if (((x17.errors$1 !== null) && (x17.errors$1.lengthCompare__I__I(1) === 0))) {
                var y$3 = $as_T(x17.errors$1.apply__I__O(0));
                var this$6 = new $c_sci_StringOps().init___T(x$3);
                var that = new $c_sci_StringOps().init___T(y$3);
                var bf = $m_s_Predef$().StringCanBuildFrom$2;
                return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T($s_sc_TraversableLike$class__$$plus$plus__sc_TraversableLike__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$6, that, bf))]))
              }
            }
          }
        };
    ...
    return $as_Lnet_devsupport_messaging_serialization_util_ParsingResult($s_sc_TraversableOnce$class__foldLeft__sc_TraversableOnce__O__F2__O(this$7, z, op))
  } else {
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["error.expected.MsgArray"]))
  }
});
$c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype.init___Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function($$outer, scd$5) {
  this.scd$5$f = scd$5;
  return this
});
var $d_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7 = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7: 0
}, false, "net.devsupport.messaging.serialization.CollectionInternalSCDeserializers$$anon$7", {
  Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7;
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype = $c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype;
$c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  var o = $as_T(obj);
  return new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T(o)
});
$c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype.init___Lnet_devsupport_messaging_serialization_DefaultInternalSerializers = (function($$outer) {
  return this
});
var $d_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$ = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$: 0
}, false, "net.devsupport.messaging.serialization.DefaultInternalSerializers$StringSerializer$", {
  Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_InternalSerializer: 1
});
$c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$;
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype = $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype;
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = this;
  return this
});
var $d_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$: 0
}, false, "net.devsupport.messaging.serialization.InternalSingleClassDeserializer$", {
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers: 1
});
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$;
var $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = (void 0);
var $m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$)) {
    $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$ = new $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$().init___()
  };
  return $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype = $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype;
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = this;
  return this
});
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(json) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgString(json)) {
    var x2 = ((json === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgString(json).value$1);
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(x2)
  } else {
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["error.expected.MsgString"]))
  }
});
var $d_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$: 0
}, false, "net.devsupport.messaging.serialization.InternalSingleClassDeserializer$StringSingleClassDeserializer$", {
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$;
var $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = (void 0);
var $m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$)) {
    $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$ = new $c_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$().init___()
  };
  return $n_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$
});
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = (function() {
  $c_O.call(this);
  this.SubscribeFormat$1 = null;
  this.SubscribeAckFormat$1 = null;
  this.UnsubscribeFormat$1 = null;
  this.PublishFormat$1 = null;
  this.WebsocketGroupsDeserializer$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype.init___ = (function() {
  $n_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = this;
  var ma = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer($m_Lnet_devsupport_messaging_serialization_InternalSerializer$().StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$());
  var fu = $m_Lnet_devsupport_serialization_macros_builders_package$().contravariantFunctorSerializer$1;
  var jsx$2 = new $c_Lplay_api_libs_functional_ContravariantFunctorOps().init___O__Lplay_api_libs_functional_ContravariantFunctor(ma, fu);
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$0$2) {
    var x$0 = $as_Lnet_devsupport_middleware_groups_websocket_api_Subscribe(x$0$2);
    return $m_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$().unapply__Lnet_devsupport_middleware_groups_websocket_api_Subscribe__s_Option(x$0)
  }));
  var jsx$1 = $as_Lnet_devsupport_messaging_serialization_Serializer(jsx$2.contramap__F1__O($m_s_PartialFunction$().unlifted__F1__s_PartialFunction(f)));
  var this$4 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2) {
    var group = $as_T(group$2);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe().init___T(group)
  }));
  this.SubscribeFormat$1 = new $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator().init___Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(jsx$1, new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$4, f$1));
  var ma$1 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer($m_Lnet_devsupport_messaging_serialization_InternalSerializer$().StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$());
  var fu$1 = $m_Lnet_devsupport_serialization_macros_builders_package$().contravariantFunctorSerializer$1;
  var jsx$4 = new $c_Lplay_api_libs_functional_ContravariantFunctorOps().init___O__Lplay_api_libs_functional_ContravariantFunctor(ma$1, fu$1);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$0$2$1) {
    var x$0$1 = $as_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck(x$0$2$1);
    return $m_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$().unapply__Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck__s_Option(x$0$1)
  }));
  var jsx$3 = $as_Lnet_devsupport_messaging_serialization_Serializer(jsx$4.contramap__F1__O($m_s_PartialFunction$().unlifted__F1__s_PartialFunction(f$2)));
  var this$8 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2$1) {
    var group$1 = $as_T(group$2$1);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck().init___T(group$1)
  }));
  this.SubscribeAckFormat$1 = new $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator().init___Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(jsx$3, new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$8, f$3));
  var ma$2 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer($m_Lnet_devsupport_messaging_serialization_InternalSerializer$().StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$());
  var fu$2 = $m_Lnet_devsupport_serialization_macros_builders_package$().contravariantFunctorSerializer$1;
  var jsx$6 = new $c_Lplay_api_libs_functional_ContravariantFunctorOps().init___O__Lplay_api_libs_functional_ContravariantFunctor(ma$2, fu$2);
  var f$4 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$0$2$2) {
    var x$0$3 = $as_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe(x$0$2$2);
    return $m_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$().unapply__Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe__s_Option(x$0$3)
  }));
  var jsx$5 = $as_Lnet_devsupport_messaging_serialization_Serializer(jsx$6.contramap__F1__O($m_s_PartialFunction$().unlifted__F1__s_PartialFunction(f$4)));
  var this$12 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f$5 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2$2) {
    var group$3 = $as_T(group$2$2);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe().init___T(group$3)
  }));
  this.UnsubscribeFormat$1 = new $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator().init___Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(jsx$5, new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$12, f$5));
  var a = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer($m_Lnet_devsupport_messaging_serialization_InternalSerializer$().StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$());
  var fcb = $m_Lnet_devsupport_serialization_macros_builders_package$().functionalCanBuildSerializer$1;
  var this$14 = new $c_Lplay_api_libs_functional_FunctionalBuilderOps().init___O__Lplay_api_libs_functional_FunctionalCanBuild(a, fcb);
  var mb = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("msg").write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer($m_Lnet_devsupport_messaging_serialization_InternalSerializer$().StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$());
  var jsx$10 = this$14.$$tilde__O__Lplay_api_libs_functional_FunctionalBuilder$CanBuild2(mb);
  var f$6 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$0$2$3) {
    var x$0$4 = $as_Lnet_devsupport_middleware_groups_websocket_api_Publish(x$0$2$3);
    return $m_Lnet_devsupport_middleware_groups_websocket_api_Publish$().unapply__Lnet_devsupport_middleware_groups_websocket_api_Publish__s_Option(x$0$4)
  }));
  var jsx$9 = $as_Lnet_devsupport_messaging_serialization_Serializer(jsx$10.apply__F1__Lplay_api_libs_functional_ContravariantFunctor__O($m_s_PartialFunction$().unlifted__F1__s_PartialFunction(f$6), $m_Lnet_devsupport_serialization_macros_builders_package$().contravariantFunctorSerializer$1));
  var a$1 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var applicativeParsingResult = $m_Lnet_devsupport_serialization_macros_builders_package$().applicativeParsingResult$1;
  var app = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8().init___Lplay_api_libs_functional_Applicative(applicativeParsingResult);
  var fcb$1 = new $c_Lplay_api_libs_functional_syntax_package$$anon$2().init___Lplay_api_libs_functional_Applicative(app);
  var this$20 = new $c_Lplay_api_libs_functional_FunctionalBuilderOps().init___O__Lplay_api_libs_functional_FunctionalCanBuild(a$1, fcb$1);
  var mb$1 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("msg").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var jsx$8 = this$20.$$tilde__O__Lplay_api_libs_functional_FunctionalBuilder$CanBuild2(mb$1);
  var jsx$7 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(group$2$3, msg$2) {
    var group$4 = $as_T(group$2$3);
    var msg = $as_T(msg$2);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Publish().init___T__T(group$4, msg)
  }));
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var applicativeParsingResult$1 = $m_Lnet_devsupport_serialization_macros_builders_package$().applicativeParsingResult$1;
  var a$2 = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8().init___Lplay_api_libs_functional_Applicative(applicativeParsingResult$1);
  this.PublishFormat$1 = new $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator().init___Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(jsx$9, $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(jsx$8.apply__F2__Lplay_api_libs_functional_Functor__O(jsx$7, new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$5().init___Lplay_api_libs_functional_Applicative(a$2))));
  this.WebsocketGroupsDeserializer$1 = new $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1().init___();
  return this
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$: 0
}, false, "net.devsupport.middleware.groups.websocket.api.WebsocketGroupsSerialization$", {
  Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$: 1,
  O: 1,
  Lnet_devsupport_serialization_macros_MacroSerialization: 1
});
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$;
var $n_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = (void 0);
var $m_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = (function() {
  if ((!$n_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$)) {
    $n_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$ = new $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$().init___()
  };
  return $n_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$
});
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$6 = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$6;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$6 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype.apply__Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_Serializer = (function(sa, sb) {
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(sa$1, sb$1) {
    return (function(x0$1$2) {
      var x0$1 = $as_Lplay_api_libs_functional_$tilde(x0$1$2);
      if ((x0$1 !== null)) {
        var a = x0$1.$$und1$1;
        var b = x0$1.$$und2$1;
        $m_Lnet_devsupport_serialization_macros_builders_package$();
        var a$1 = sa$1.serialize__O__sci_Map(a);
        var b$1 = sb$1.serialize__O__sci_Map(b);
        var jsx$1 = a$1.$$plus$plus__sc_GenTraversableOnce__sci_Map(b$1)
      } else {
        var jsx$1;
        throw new $c_s_MatchError().init___O(x0$1)
      };
      return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(jsx$1)
    })
  })(sa, sb));
  return new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$1().init___F1(f)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype.apply__O__O__O = (function(ma, mb) {
  return this.apply__Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_Serializer($as_Lnet_devsupport_messaging_serialization_Serializer(ma), $as_Lnet_devsupport_messaging_serialization_Serializer(mb))
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$6 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$6: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$6", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$6: 1,
  O: 1,
  Lplay_api_libs_functional_FunctionalCanBuild: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$6.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$6;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$7 = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$7;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$7 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype.map__O__F1__O = (function(m, f) {
  var m$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(m);
  return $s_Lnet_devsupport_messaging_serialization_util_ParsingResult$class__map__Lnet_devsupport_messaging_serialization_util_ParsingResult__F1__Lnet_devsupport_messaging_serialization_util_ParsingResult(m$1, f)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype.apply__O__O__O = (function(mf, ma) {
  return this.apply__Lnet_devsupport_messaging_serialization_util_ParsingResult__Lnet_devsupport_messaging_serialization_util_ParsingResult__Lnet_devsupport_messaging_serialization_util_ParsingResult($as_Lnet_devsupport_messaging_serialization_util_ParsingResult(mf), $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(ma))
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype.apply__Lnet_devsupport_messaging_serialization_util_ParsingResult__Lnet_devsupport_messaging_serialization_util_ParsingResult__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(mf, ma) {
  var x1 = new $c_T2().init___O__O(mf, ma);
  var p2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und1$f);
  var p3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und2$f);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p2)) {
    var x4 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p2);
    var f = $as_F1(x4.value$1);
    if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p3)) {
      var x5 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(p3);
      var a = x5.value$1;
      return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(f.apply__O__O(a))
    }
  };
  var p6 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und1$f);
  var p7 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und2$f);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p6)) {
    var x8 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p6);
    if (((x8.errors$1 !== null) && (x8.errors$1.lengthCompare__I__I(1) === 0))) {
      var e1 = $as_T(x8.errors$1.apply__I__O(0));
      if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p7)) {
        var x9 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p7);
        if (((x9.errors$1 !== null) && (x9.errors$1.lengthCompare__I__I(1) === 0))) {
          var e2 = $as_T(x9.errors$1.apply__I__O(0));
          return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e1, e2]))
        }
      }
    }
  };
  var p10 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und1$f);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p10)) {
    var x12 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p10);
    if (((x12.errors$1 !== null) && (x12.errors$1.lengthCompare__I__I(1) === 0))) {
      var e = $as_T(x12.errors$1.apply__I__O(0));
      return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e]))
    }
  };
  var p14 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(x1.$$und2$f);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(p14)) {
    var x15 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(p14);
    if (((x15.errors$1 !== null) && (x15.errors$1.lengthCompare__I__I(1) === 0))) {
      var e$2 = $as_T(x15.errors$1.apply__I__O(0));
      return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e$2]))
    }
  };
  throw new $c_s_MatchError().init___O(x1)
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$7 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$7: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$7", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$7: 1,
  O: 1,
  Lplay_api_libs_functional_Applicative: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$7.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$7;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8 = (function() {
  $c_O.call(this);
  this.applicativeParsingResult$1$f = null
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$8 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype.map__O__F1__O = (function(m, f) {
  var m$1 = $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(m);
  return new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(m$1, f)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype.init___Lplay_api_libs_functional_Applicative = (function(applicativeParsingResult$1) {
  this.applicativeParsingResult$1$f = applicativeParsingResult$1;
  return this
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype.apply__O__O__O = (function(mf, ma) {
  var mf$1 = $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(mf);
  var ma$1 = $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(ma);
  return new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4().init___Lnet_devsupport_serialization_macros_builders_package$$anon$8__Lnet_devsupport_messaging_serialization_SingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(this, mf$1, ma$1)
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$8 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$8: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$8", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$8: 1,
  O: 1,
  Lplay_api_libs_functional_Applicative: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$8;
/** @constructor */
var $c_Lplay_api_libs_functional_syntax_package$$anon$2 = (function() {
  $c_O.call(this);
  this.app$1$1 = null
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype = new $h_O();
$c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype.constructor = $c_Lplay_api_libs_functional_syntax_package$$anon$2;
/** @constructor */
var $h_Lplay_api_libs_functional_syntax_package$$anon$2 = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_syntax_package$$anon$2.prototype = $c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype;
$c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype.init___Lplay_api_libs_functional_Applicative = (function(app$1) {
  this.app$1$1 = app$1;
  return this
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype.apply__O__O__O = (function(a, b) {
  return this.app$1$1.apply__O__O__O(this.app$1$1.map__O__F1__O(a, new $c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1().init___Lplay_api_libs_functional_syntax_package$$anon$2(this)), b)
});
var $d_Lplay_api_libs_functional_syntax_package$$anon$2 = new $ClassTypeData({
  Lplay_api_libs_functional_syntax_package$$anon$2: 0
}, false, "play.api.libs.functional.syntax.package$$anon$2", {
  Lplay_api_libs_functional_syntax_package$$anon$2: 1,
  O: 1,
  Lplay_api_libs_functional_FunctionalCanBuild: 1
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2.prototype.$classData = $d_Lplay_api_libs_functional_syntax_package$$anon$2;
...
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_InternalSerializer$ = (function() {
  $c_O.call(this);
  this.IntSerializer$module$1 = null;
  this.ShortSerializer$module$1 = null;
  this.ByteSerializer$module$1 = null;
  this.LongSerializer$module$1 = null;
  this.FloatSerializer$module$1 = null;
  this.DoubleSerializer$module$1 = null;
  this.BooleanSerializer$module$1 = null;
  this.StringSerializer$module$1 = null;
  this.MsgValueSerializer$module$1 = null
});
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_InternalSerializer$;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_InternalSerializer$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype = $c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype;
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_serialization_InternalSerializer$ = this;
  return this
});
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype.StringSerializer$lzycompute__p1__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$ = (function() {
  if ((this.StringSerializer$module$1 === null)) {
    this.StringSerializer$module$1 = new $c_Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$().init___Lnet_devsupport_messaging_serialization_DefaultInternalSerializers(this)
  };
  return this.StringSerializer$module$1
});
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype.StringSerializer__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$ = (function() {
  return ((this.StringSerializer$module$1 === null) ? this.StringSerializer$lzycompute__p1__Lnet_devsupport_messaging_serialization_DefaultInternalSerializers$StringSerializer$() : this.StringSerializer$module$1)
});
var $d_Lnet_devsupport_messaging_serialization_InternalSerializer$ = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_InternalSerializer$: 0
}, false, "net.devsupport.messaging.serialization.InternalSerializer$", {
  Lnet_devsupport_messaging_serialization_InternalSerializer$: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_DefaultInternalSerializers: 1,
  Lnet_devsupport_messaging_serialization_CollectionInternalSerializers: 1
});
$c_Lnet_devsupport_messaging_serialization_InternalSerializer$.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_InternalSerializer$;
var $n_Lnet_devsupport_messaging_serialization_InternalSerializer$ = (void 0);
var $m_Lnet_devsupport_messaging_serialization_InternalSerializer$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_serialization_InternalSerializer$)) {
    $n_Lnet_devsupport_messaging_serialization_InternalSerializer$ = new $c_Lnet_devsupport_messaging_serialization_InternalSerializer$().init___()
  };
  return $n_Lnet_devsupport_messaging_serialization_InternalSerializer$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1 = (function() {
  $c_O.call(this);
  this.$$outer$1 = null;
  this.f$2$1 = null
});
$c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype = $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype;
$c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype.init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1 = (function($$outer, f$2) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$1 = $$outer
...
$c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  var this$1 = this.$$outer$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg);
  var f = this.f$2$1;
  return $s_Lnet_devsupport_messaging_serialization_util_ParsingResult$class__map__Lnet_devsupport_messaging_serialization_util_ParsingResult__F1__Lnet_devsupport_messaging_serialization_util_ParsingResult(this$1, f)
});
var $d_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1 = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1: 0
}, false, "net.devsupport.messaging.serialization.SingleClassDeserializer$$anon$1", {
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1;
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1 = (function() {
  $c_O.call(this);
  this.classMap$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype.init___ = (function() {
  var a = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var applicativeParsingResult = $m_Lnet_devsupport_serialization_macros_builders_package$().applicativeParsingResult$1;
  var app = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8().init___Lplay_api_libs_functional_Applicative(applicativeParsingResult);
  var fcb = new $c_Lplay_api_libs_functional_syntax_package$$anon$2().init___Lplay_api_libs_functional_Applicative(app);
  var this$5 = new $c_Lplay_api_libs_functional_FunctionalBuilderOps().init___O__Lplay_api_libs_functional_FunctionalCanBuild(a, fcb);
  var mb = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("msg").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var jsx$4 = this$5.$$tilde__O__Lplay_api_libs_functional_FunctionalBuilder$CanBuild2(mb);
  var jsx$3 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(group$2, msg$2) {
    var group = $as_T(group$2);
    var msg = $as_T(msg$2);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Publish().init___T__T(group, msg)
  }));
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var applicativeParsingResult$1 = $m_Lnet_devsupport_serialization_macros_builders_package$().applicativeParsingResult$1;
  var a$1 = new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8().init___Lplay_api_libs_functional_Applicative(applicativeParsingResult$1);
  var y = jsx$4.apply__F2__Lplay_api_libs_functional_Functor__O(jsx$3, new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$5().init___Lplay_api_libs_functional_Applicative(a$1));
  var jsx$5 = new $c_T2().init___O__O("net.devsupport.middleware.groups.websocket.api.Publish", y);
  var this$10 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2$1) {
    var group$1 = $as_T(group$2$1);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe().init___T(group$1)
  }));
  var y$1 = new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$10, f);
  var jsx$2 = new $c_T2().init___O__O("net.devsupport.middleware.groups.websocket.api.Unsubscribe", y$1);
  var this$13 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2$2) {
    var group$3 = $as_T(group$2$2);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck().init___T(group$3)
  }));
  var y$2 = new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$13, f$1);
  var jsx$1 = new $c_T2().init___O__O("net.devsupport.middleware.groups.websocket.api.SubscribeAck", y$2);
  var this$16 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$().$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath("group").read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer($m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$());
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(group$2$3) {
    var group$4 = $as_T(group$2$3);
    return new $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe().init___T(group$4)
  }));
  var y$3 = new $c_Lnet_devsupport_messaging_serialization_SingleClassDeserializer$$anon$1().init___Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1(this$16, f$2);
  var array = [jsx$5, jsx$2, jsx$1, new $c_T2().init___O__O("net.devsupport.middleware.groups.websocket.api.Subscribe", y$3)];
  ...
  this.classMap$1 = $as_sci_Map(this$19.elems$1);
  return this
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1 = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1: 0
}, false, "net.devsupport.middleware.groups.websocket.api.WebsocketGroupsSerialization$$anon$1", {
  Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1: 1,
  O: 1,
  Lnet_devsupport_serialization_macros_impl_MacroDeserializer: 1,
  Lnet_devsupport_messaging_serialization_Deserializer: 1
});
$c_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_WebsocketGroupsSerialization$$anon$1;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$1 = (function() {
  $c_O.call(this);
  this.f$1$1 = null
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$1;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(this.serialize__O__sci_Map(obj))
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype.init___F1 = (function(f$1) {
  this.f$1$1 = f$1;
  return this
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype.serialize__O__sci_Map = (function(obj) {
  var $$this = $as_Lnet_devsupport_messaging_format_package$MsgObject(this.f$1$1.apply__O__O(obj)).value$1;
  var y = new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T($objectGetClass(obj).getName__T());
  var v = new $c_T2().init___O__O("tpe", y);
  return $$this.$$plus__T2__sci_Map(v)
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$1 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$1: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$1", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$1: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_Serializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSerializer: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$1.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$1;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$2 = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$2;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$2 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype.contramap__Lnet_devsupport_messaging_serialization_Serializer__F1__Lnet_devsupport_messaging_serialization_Serializer = (function(sa, f) {
  $m_Lnet_devsupport_serialization_macros_builders_package$();
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(sa$2, f$2) {
    return (function(b$2) {
      return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(sa$2.serialize__O__sci_Map(f$2.apply__O__O(b$2)))
    })
  })(sa, f));
  return new $c_Lnet_devsupport_serialization_macros_builders_package$$anon$1().init___F1(f$1)
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$2 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$2: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$2", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$2: 1,
  O: 1,
  Lplay_api_libs_functional_ContravariantFunctor: 1,
  Lplay_api_libs_functional_Variant: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$2.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$2;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$5 = (function() {
  $c_O.call(this);
  this.a$2$1 = null
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$5;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$5 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype.init___Lplay_api_libs_functional_Applicative = (function(a$2) {
  this.a$2$1 = a$2;
  return this
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype.fmap__Lnet_devsupport_messaging_serialization_SingleClassDeserializer__F1__Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(reads, f) {
  return $as_Lnet_devsupport_messaging_serialization_SingleClassDeserializer(this.a$2$1.map__O__F1__O(reads, f))
});
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$5 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$5: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$5", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$5: 1,
  O: 1,
  Lplay_api_libs_functional_Functor: 1,
  Lplay_api_libs_functional_Variant: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$5.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$5;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4 = (function() {
  $c_O.call(this);
  this.$$outer$1 = null;
  this.mf$1$1 = null;
  this.ma$1$1 = null
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype.constructor = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype = $c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype;
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  return $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(this.$$outer$1.applicativeParsingResult$1$f.apply__O__O__O(this.mf$1$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg), this.ma$1$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg)))
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype.init___Lnet_devsupport_serialization_macros_builders_package$$anon$8__Lnet_devsupport_messaging_serialization_SingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function($$outer, mf$1, ma$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$1 = $$outer
...
var $d_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4: 0
}, false, "net.devsupport.serialization.macros.builders.package$$anon$8$$anon$4", {
  Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4.prototype.$classData = $d_Lnet_devsupport_serialization_macros_builders_package$$anon$8$$anon$4;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1 = (function() {
  $c_O.call(this);
  this.path$1$1 = null;
  this.evidence$1$1$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype;
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(this.serialize__O__sci_Map(obj))
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype.init___Lnet_devsupport_serialization_macros_impl_MsgPath__T__Lnet_devsupport_messaging_serialization_InternalSerializer = (function($$outer, path$1, evidence$1$1) {
  this.path$1$1 = path$1;
  this.evidence$1$1$1 = evidence$1$1;
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype.serialize__O__sci_Map = (function(obj) {
  var $$this = this.path$1$1;
  var y = this.evidence$1$1$1.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue(obj);
  var array = [new $c_T2().init___O__O($$this, y)];
  ...
  return $as_sci_Map(this$5.elems$1)
});
var $d_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1: 0
}, false, "net.devsupport.serialization.macros.impl.MsgPath$$anon$1", {
  Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_Serializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSerializer: 1
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4 = (function() {
  $c_O.call(this);
  this.path$2$1 = null;
  this.evidence$2$1$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype;
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  var thiz = this.path$2$1;
  if ((thiz === null)) {
    var jsx$1;
    throw new $c_jl_NullPointerException().init___()
  } else {
  ...
  if ((jsx$1 === "")) {
    return this.evidence$2$1$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg)
  };
  if ($is_Lnet_devsupport_messaging_format_package$MsgObject(msg)) {
    var x2 = ((msg === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(msg).value$1);
    if (x2.contains__O__Z(this.path$2$1)) {
      return this.evidence$2$1$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult($as_Lnet_devsupport_messaging_format_package$MsgValue(x2.apply__O__O(this.path$2$1)))
    }
  };
  return new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["expected MsgObject at ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.path$2$1]))]))
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype.init___Lnet_devsupport_serialization_macros_impl_MsgPath__T__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer = (function($$outer, path$2, evidence$2$1) {
  this.path$2$1 = path$2;
  this.evidence$2$1$1 = evidence$2$1;
  return this
});
var $d_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4: 0
}, false, "net.devsupport.serialization.macros.impl.MsgPath$$anon$4", {
  Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1 = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype;
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype.init___ = (function() {
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(this.serialize__O__sci_Map(obj))
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype.serialize__O__sci_Map = (function(o) {
  var $$this = $m_Lnet_devsupport_serialization_macros_impl_SerializationMacros$().TypeField$1;
  var y = new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T($objectGetClass(o).getName__T());
  var array = [new $c_T2().init___O__O($$this, y)];
  ...
  return $as_sci_Map(this$4.elems$1)
});
var $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1: 0
}, false, "net.devsupport.serialization.macros.impl.SerializationMacros$$anon$1", {
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_Serializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSerializer: 1
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$1;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3 = (function() {
  $c_O.call(this);
  this.readMap$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype = $c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype;
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype.init___ = (function() {
  var jsx$1 = $m_Lnet_devsupport_serialization_macros_impl_MsgPath$();
  var this$1 = $m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$();
  var scd = $m_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer$StringSingleClassDeserializer$();
  this.readMap$1 = jsx$1.read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer(new $c_Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers$$anon$7().init___Lnet_devsupport_messaging_serialization_CollectionInternalSCDeserializers__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(this$1, scd));
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  var this$1 = this.readMap$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$1)) {
    var x2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$1);
    var v = x2.value$1;
    var values = $as_sci_Map(v);
    return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(new $c_Lnet_devsupport_messaging_Header().init___sci_Map(values))
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(this$1)) {
    var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(this$1);
    return x3
  } else {
    throw new $c_s_MatchError().init___O(this$1)
  }
});
var $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3: 0
}, false, "net.devsupport.serialization.macros.impl.SerializationMacros$$anon$3", {
  Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1
});
$c_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_SerializationMacros$$anon$3;
...
var $is_s_PartialFunction$Lifted = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.s_PartialFunction$Lifted)))
});
var $as_s_PartialFunction$Lifted = (function(obj) {
  return (($is_s_PartialFunction$Lifted(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "scala.PartialFunction$Lifted"))
});
var $isArrayOf_s_PartialFunction$Lifted = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.s_PartialFunction$Lifted)))
});
var $asArrayOf_s_PartialFunction$Lifted = (function(obj, depth) {
  return (($isArrayOf_s_PartialFunction$Lifted(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscala.PartialFunction$Lifted;", depth))
});
/** @constructor */
...
var $d_sci_Stream$StreamWithFilter = new $ClassTypeData({
...
/** @constructor */
var $c_s_PartialFunction$Unlifted = (function() {
  $c_sr_AbstractPartialFunction.call(this);
  this.f$2 = null
});
$c_s_PartialFunction$Unlifted.prototype = new $h_sr_AbstractPartialFunction();
$c_s_PartialFunction$Unlifted.prototype.constructor = $c_s_PartialFunction$Unlifted;
/** @constructor */
var $h_s_PartialFunction$Unlifted = (function() {
  /*<skip>*/
});
$h_s_PartialFunction$Unlifted.prototype = $c_s_PartialFunction$Unlifted.prototype;
$c_s_PartialFunction$Unlifted.prototype.init___F1 = (function(f) {
  this.f$2 = f;
  return this
});
$c_s_PartialFunction$Unlifted.prototype.applyOrElse__O__F1__O = (function(x, default$2) {
  var z = $as_s_Option(this.f$2.apply__O__O(x));
  return ((!z.isEmpty__Z()) ? z.get__O() : default$2.apply__O__O(x))
});
var $d_s_PartialFunction$Unlifted = new $ClassTypeData({
  s_PartialFunction$Unlifted: 0
}, false, "scala.PartialFunction$Unlifted", {
  s_PartialFunction$Unlifted: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1
});
$c_s_PartialFunction$Unlifted.prototype.$classData = $d_s_PartialFunction$Unlifted;
/** @constructor */
...
var $d_scm_DefaultEntry = new $ClassTypeData({
  scm_DefaultEntry: 0
...
var $d_sjs_js_WrappedDictionary$DictionaryIterator = new $ClassTypeData({
...
/** @constructor */
var $c_Lnet_devsupport_framework_JsFramework$$anonfun$2 = (function() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
});
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype.constructor = $c_Lnet_devsupport_framework_JsFramework$$anonfun$2;
/** @constructor */
var $h_Lnet_devsupport_framework_JsFramework$$anonfun$2 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype = $c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype;
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype.apply__O__O = (function(v1) {
  this.apply__Lorg_scalajs_dom_raw_Event__V(v1)
});
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype.init___Lnet_devsupport_framework_JsFramework = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype.apply__Lorg_scalajs_dom_raw_Event__V = (function(e) {
  var this$2 = $m_s_Console$();
  var this$3 = this$2.outVar$2;
  var this$4 = $as_Ljava_io_PrintStream(this$3.tl$1.get__O());
  this$4.printString__p4__T__V((((("(" + "onopen") + ",") + e) + ")"));
  this$4.printString__p4__T__V("\n");
  var this$6 = this.$$outer$2.net$devsupport$framework$JsFramework$$stash$1;
  var these = this$6;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var msg = $as_T(arg1);
    ...
    var this$10 = $as_Ljava_io_PrintStream(this$9.tl$1.get__O());
    this$10.printString__p4__T__V((((("(" + "send from stash") + ",") + msg) + ")"));
    this$10.printString__p4__T__V("\n");
    this.$$outer$2.net$devsupport$framework$JsFramework$$ws$1["send"](msg);
    var this$13 = these;
    these = this$13.tail__sci_List()
  };
  this.$$outer$2.net$devsupport$framework$JsFramework$$stash$1 = $m_sci_Nil$();
  this.$$outer$2.net$devsupport$framework$JsFramework$$open$1 = true
});
var $d_Lnet_devsupport_framework_JsFramework$$anonfun$2 = new $ClassTypeData({
  Lnet_devsupport_framework_JsFramework$$anonfun$2: 0
}, false, "net.devsupport.framework.JsFramework$$anonfun$2", {
  Lnet_devsupport_framework_JsFramework$$anonfun$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_framework_JsFramework$$anonfun$2.prototype.$classData = $d_Lnet_devsupport_framework_JsFramework$$anonfun$2;
/** @constructor */
var $c_Lnet_devsupport_messaging_Envelope = (function() {
  $c_O.call(this);
  this.msg$1 = null;
  this.header$1 = null
});
$c_Lnet_devsupport_messaging_Envelope.prototype = new $h_O();
$c_Lnet_devsupport_messaging_Envelope.prototype.constructor = $c_Lnet_devsupport_messaging_Envelope;
/** @constructor */
var $h_Lnet_devsupport_messaging_Envelope = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_Envelope.prototype = $c_Lnet_devsupport_messaging_Envelope.prototype;
$c_Lnet_devsupport_messaging_Envelope.prototype.productPrefix__T = (function() {
  return "Envelope"
});
$c_Lnet_devsupport_messaging_Envelope.prototype.productArity__I = (function() {
  return 2
});
$c_Lnet_devsupport_messaging_Envelope.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_messaging_Envelope(x$1)) {
    var Envelope$1 = $as_Lnet_devsupport_messaging_Envelope(x$1);
    if ($m_sr_BoxesRunTime$().equals__O__O__Z(this.msg$1, Envelope$1.msg$1)) {
      var x = this.header$1;
      var x$2 = Envelope$1.header$1;
...
$c_Lnet_devsupport_messaging_Envelope.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.msg$1;
...
$c_Lnet_devsupport_messaging_Envelope.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_messaging_Envelope.prototype.init___O__Lnet_devsupport_messaging_Header = (function(msg, header) {
  this.msg$1 = msg;
  this.header$1 = header;
  return this
});
$c_Lnet_devsupport_messaging_Envelope.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_messaging_Envelope.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_messaging_Envelope = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_Envelope)))
});
var $as_Lnet_devsupport_messaging_Envelope = (function(obj) {
  return (($is_Lnet_devsupport_messaging_Envelope(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.Envelope"))
});
var $isArrayOf_Lnet_devsupport_messaging_Envelope = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_Envelope)))
});
var $asArrayOf_Lnet_devsupport_messaging_Envelope = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_Envelope(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.Envelope;", depth))
});
var $d_Lnet_devsupport_messaging_Envelope = new $ClassTypeData({
  Lnet_devsupport_messaging_Envelope: 0
}, false, "net.devsupport.messaging.Envelope", {
  Lnet_devsupport_messaging_Envelope: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_Envelope.prototype.$classData = $d_Lnet_devsupport_messaging_Envelope;
/** @constructor */
var $c_Lnet_devsupport_messaging_Header = (function() {
  $c_O.call(this);
  this.values$1 = null
});
$c_Lnet_devsupport_messaging_Header.prototype = new $h_O();
$c_Lnet_devsupport_messaging_Header.prototype.constructor = $c_Lnet_devsupport_messaging_Header;
/** @constructor */
var $h_Lnet_devsupport_messaging_Header = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_Header.prototype = $c_Lnet_devsupport_messaging_Header.prototype;
$c_Lnet_devsupport_messaging_Header.prototype.productPrefix__T = (function() {
  return "Header"
});
$c_Lnet_devsupport_messaging_Header.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_messaging_Header.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_messaging_Header(x$1)) {
    var Header$1 = $as_Lnet_devsupport_messaging_Header(x$1);
    var x = this.values$1;
    var x$2 = Header$1.values$1;
    return ((x === null) ? (x$2 === null) : $s_sc_GenMapLike$class__equals__sc_GenMapLike__O__Z(x, x$2))
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_Header.prototype.init___sci_Map = (function(values) {
  this.values$1 = values;
  return this
});
$c_Lnet_devsupport_messaging_Header.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
...
$c_Lnet_devsupport_messaging_Header.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_messaging_Header.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_messaging_Header.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_messaging_Header = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_Header)))
});
var $as_Lnet_devsupport_messaging_Header = (function(obj) {
  return (($is_Lnet_devsupport_messaging_Header(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.Header"))
});
var $isArrayOf_Lnet_devsupport_messaging_Header = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_Header)))
});
var $asArrayOf_Lnet_devsupport_messaging_Header = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_Header(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.Header;", depth))
});
var $d_Lnet_devsupport_messaging_Header = new $ClassTypeData({
  Lnet_devsupport_messaging_Header: 0
}, false, "net.devsupport.messaging.Header", {
  Lnet_devsupport_messaging_Header: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_Header.prototype.$classData = $d_Lnet_devsupport_messaging_Header;
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgArray$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgArray$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgArray$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgArray$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.apply__O__O = (function(v1) {
  var value = $as_sc_Seq(v1);
  return new $c_Lnet_devsupport_messaging_format_package$MsgArray().init___sc_Seq(value)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.toString$extension__sc_Seq__T = (function($$this) {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(new $c_Lnet_devsupport_messaging_format_package$MsgArray().init___sc_Seq($$this))
});
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.productIterator$extension__sc_Seq__sc_Iterator = (function($$this) {
  var x = new $c_Lnet_devsupport_messaging_format_package$MsgArray().init___sc_Seq($$this);
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(x)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.toString__T = (function() {
  return "MsgArray"
});
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.productElement$extension__sc_Seq__I__O = (function($$this, x$1) {
  switch (x$1) {
    case 0:
      {
        return $$this;
...
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.equals$extension__sc_Seq__O__Z = (function($$this, x$1) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgArray(x$1)) {
    var MsgArray$1 = ((x$1 === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgArray(x$1).value$1);
    return (($$this === null) ? (MsgArray$1 === null) : $$this.equals__O__Z(MsgArray$1))
  } else {
    return false
  }
});
var $d_Lnet_devsupport_messaging_format_package$MsgArray$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgArray$: 0
}, false, "net.devsupport.messaging.format.package$MsgArray$", {
  Lnet_devsupport_messaging_format_package$MsgArray$: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgArray$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgArray$;
var $n_Lnet_devsupport_messaging_format_package$MsgArray$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgArray$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgArray$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgArray$ = new $c_Lnet_devsupport_messaging_format_package$MsgArray$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgArray$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgLong$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgLong$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgLong$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgLong$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.apply__O__O = (function(v1) {
  var value = $uJ(v1);
  return new $c_Lnet_devsupport_messaging_format_package$MsgLong().init___J(value)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.equals$extension__J__O__Z = (function($$this, x$1) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgLong(x$1)) {
    var MsgLong$1 = $as_Lnet_devsupport_messaging_format_package$MsgLong(x$1).value$1;
    return $$this.equals__sjsr_RuntimeLong__Z(MsgLong$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.toString$extension__J__T = (function($$this) {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(new $c_Lnet_devsupport_messaging_format_package$MsgLong().init___J($$this))
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.toString__T = (function() {
  return "MsgLong"
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.productIterator$extension__J__sc_Iterator = (function($$this) {
  var x = new $c_Lnet_devsupport_messaging_format_package$MsgLong().init___J($$this);
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(x)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.productElement$extension__J__I__O = (function($$this, x$1) {
  switch (x$1) {
    case 0:
      {
        return $$this;
...
var $d_Lnet_devsupport_messaging_format_package$MsgLong$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgLong$: 0
}, false, "net.devsupport.messaging.format.package$MsgLong$", {
  Lnet_devsupport_messaging_format_package$MsgLong$: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgLong$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgLong$;
var $n_Lnet_devsupport_messaging_format_package$MsgLong$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgLong$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgLong$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgLong$ = new $c_Lnet_devsupport_messaging_format_package$MsgLong$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgLong$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgNumber$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgNumber$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgNumber$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.equals$extension__D__O__Z = (function($$this, x$1) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgNumber(x$1)) {
    var MsgNumber$1 = $as_Lnet_devsupport_messaging_format_package$MsgNumber(x$1).value$1;
    return ($$this === MsgNumber$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.apply__O__O = (function(v1) {
  var value = $uD(v1);
  return new $c_Lnet_devsupport_messaging_format_package$MsgNumber().init___D(value)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.toString__T = (function() {
  return "MsgNumber"
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.toString$extension__D__T = (function($$this) {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(new $c_Lnet_devsupport_messaging_format_package$MsgNumber().init___D($$this))
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.productIterator$extension__D__sc_Iterator = (function($$this) {
  var x = new $c_Lnet_devsupport_messaging_format_package$MsgNumber().init___D($$this);
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(x)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.productElement$extension__D__I__O = (function($$this, x$1) {
  switch (x$1) {
    case 0:
      {
        return $$this;
...
var $d_Lnet_devsupport_messaging_format_package$MsgNumber$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgNumber$: 0
}, false, "net.devsupport.messaging.format.package$MsgNumber$", {
  Lnet_devsupport_messaging_format_package$MsgNumber$: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgNumber$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgNumber$;
var $n_Lnet_devsupport_messaging_format_package$MsgNumber$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgNumber$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgNumber$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgNumber$ = new $c_Lnet_devsupport_messaging_format_package$MsgNumber$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgNumber$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgObject$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgObject$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgObject$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgObject$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.apply__O__O = (function(v1) {
  var value = $as_sci_Map(v1);
  return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(value)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.productElement$extension__sci_Map__I__O = (function($$this, x$1) {
  switch (x$1) {
    case 0:
      {
        return $$this;
...
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.toString__T = (function() {
  return "MsgObject"
});
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.productIterator$extension__sci_Map__sc_Iterator = (function($$this) {
  var x = new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map($$this);
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(x)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.equals$extension__sci_Map__O__Z = (function($$this, x$1) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgObject(x$1)) {
    var MsgObject$1 = ((x$1 === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgObject(x$1).value$1);
    return (($$this === null) ? (MsgObject$1 === null) : $s_sc_GenMapLike$class__equals__sc_GenMapLike__O__Z($$this, MsgObject$1))
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.toString$extension__sci_Map__T = (function($$this) {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map($$this))
});
var $d_Lnet_devsupport_messaging_format_package$MsgObject$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgObject$: 0
}, false, "net.devsupport.messaging.format.package$MsgObject$", {
  Lnet_devsupport_messaging_format_package$MsgObject$: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgObject$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgObject$;
var $n_Lnet_devsupport_messaging_format_package$MsgObject$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgObject$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgObject$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgObject$ = new $c_Lnet_devsupport_messaging_format_package$MsgObject$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgObject$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgString$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgString$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgString$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgString$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgString$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.apply__O__O = (function(v1) {
  var value = $as_T(v1);
  return new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T(value)
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.equals$extension__T__O__Z = (function($$this, x$1) {
  if ($is_Lnet_devsupport_messaging_format_package$MsgString(x$1)) {
    var MsgString$1 = ((x$1 === null) ? null : $as_Lnet_devsupport_messaging_format_package$MsgString(x$1).value$1);
    return ($$this === MsgString$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.toString$extension__T__T = (function($$this) {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T($$this))
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.productIterator$extension__T__sc_Iterator = (function($$this) {
  var x = new $c_Lnet_devsupport_messaging_format_package$MsgString().init___T($$this);
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(x)
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.toString__T = (function() {
  return "MsgString"
});
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.productElement$extension__T__I__O = (function($$this, x$1) {
  switch (x$1) {
    case 0:
      {
        return $$this;
...
var $d_Lnet_devsupport_messaging_format_package$MsgString$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgString$: 0
}, false, "net.devsupport.messaging.format.package$MsgString$", {
  Lnet_devsupport_messaging_format_package$MsgString$: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgString$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgString$;
var $n_Lnet_devsupport_messaging_format_package$MsgString$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgString$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgString$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgString$ = new $c_Lnet_devsupport_messaging_format_package$MsgString$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgString$
});
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function() {
  $c_O.call(this);
  this.group$1 = null;
  this.msg$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Publish;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.init___T__T = (function(group, msg) {
  this.group$1 = group;
  this.msg$1 = msg;
  return this
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.productPrefix__T = (function() {
  return "Publish"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.productArity__I = (function() {
  return 2
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_middleware_groups_websocket_api_Publish(x$1)) {
    var Publish$1 = $as_Lnet_devsupport_middleware_groups_websocket_api_Publish(x$1);
    return ((this.group$1 === Publish$1.group$1) && (this.msg$1 === Publish$1.msg$1))
  } else {
    return false
  }
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.group$1;
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Publish)))
});
var $as_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function(obj) {
  return (($is_Lnet_devsupport_middleware_groups_websocket_api_Publish(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.middleware.groups.websocket.api.Publish"))
});
var $isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Publish)))
});
var $asArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Publish = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Publish(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.middleware.groups.websocket.api.Publish;", depth))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_Publish = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_Publish: 0
}, false, "net.devsupport.middleware.groups.websocket.api.Publish", {
  Lnet_devsupport_middleware_groups_websocket_api_Publish: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Publish;
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Publish$ = (function() {
  $c_sr_AbstractFunction2.call(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish$.prototype = new $h_sr_AbstractFunction2();
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish$.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Publish$;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Publish$ = (function() {
  /*<skip>*/
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish$.prototype.unapply__Lnet_devsupport_middleware_groups_websocket_api_Publish__s_Option = (function(x$0) {
  return ((x$0 === null) ? $m_s_None$() : new $c_s_Some().init___O(new $c_T2().init___O__O(x$0.group$1, x$0.msg$1)))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish$.prototype.apply__O__O__O = (function(v1, v2) {
  var group = $as_T(v1);
  var msg = $as_T(v2);
  return new $c_Lnet_devsupport_middleware_groups_websocket_api_Publish().init___T__T(group, msg)
});
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Publish$.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Publish$;
var $n_Lnet_devsupport_middleware_groups_websocket_api_Publish$ = (void 0);
var $m_Lnet_devsupport_middleware_groups_websocket_api_Publish$ = (function() {
  if ((!$n_Lnet_devsupport_middleware_groups_websocket_api_Publish$)) {
    $n_Lnet_devsupport_middleware_groups_websocket_api_Publish$ = new $c_Lnet_devsupport_middleware_groups_websocket_api_Publish$().init___()
  };
  return $n_Lnet_devsupport_middleware_groups_websocket_api_Publish$
});
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function() {
  $c_O.call(this);
  this.group$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.productPrefix__T = (function() {
  return "Subscribe"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_middleware_groups_websocket_api_Subscribe(x$1)) {
    var Subscribe$1 = $as_Lnet_devsupport_middleware_groups_websocket_api_Subscribe(x$1);
    return (this.group$1 === Subscribe$1.group$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.group$1;
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.init___T = (function(group) {
  this.group$1 = group;
  return this
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Subscribe)))
});
var $as_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function(obj) {
  return (($is_Lnet_devsupport_middleware_groups_websocket_api_Subscribe(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.middleware.groups.websocket.api.Subscribe"))
});
var $isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Subscribe)))
});
var $asArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Subscribe(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.middleware.groups.websocket.api.Subscribe;", depth))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_Subscribe = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_Subscribe: 0
}, false, "net.devsupport.middleware.groups.websocket.api.Subscribe", {
  Lnet_devsupport_middleware_groups_websocket_api_Subscribe: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Subscribe;
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$ = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype.unapply__Lnet_devsupport_middleware_groups_websocket_api_Subscribe__s_Option = (function(x$0) {
  return ((x$0 === null) ? $m_s_None$() : new $c_s_Some().init___O(x$0.group$1))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype.apply__O__O = (function(v1) {
  var group = $as_T(v1);
  return new $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe().init___T(group)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype.toString__T = (function() {
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$;
var $n_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$ = (void 0);
var $m_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$ = (function() {
  if ((!$n_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$)) {
    $n_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$ = new $c_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$().init___()
  };
  return $n_Lnet_devsupport_middleware_groups_websocket_api_Subscribe$
});
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function() {
  $c_O.call(this);
  this.group$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.productPrefix__T = (function() {
  return "SubscribeAck"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck(x$1)) {
    var SubscribeAck$1 = $as_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck(x$1);
    return (this.group$1 === SubscribeAck$1.group$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.group$1;
...
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.init___T = (function(group) {
  this.group$1 = group;
  return this
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck)))
});
var $as_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function(obj) {
  return (($is_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.middleware.groups.websocket.api.SubscribeAck"))
});
var $isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck)))
});
var $asArrayOf_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.middleware.groups.websocket.api.SubscribeAck;", depth))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck: 0
}, false, "net.devsupport.middleware.groups.websocket.api.SubscribeAck", {
  Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck;
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype.apply__O__O = (function(v1) {
  var group = $as_T(v1);
  return new $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck().init___T(group)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype.toString__T = (function() {
  return "SubscribeAck"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype.unapply__Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck__s_Option = (function(x$0) {
  return ((x$0 === null) ? $m_s_None$() : new $c_s_Some().init___O(x$0.group$1))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$: 0
...
$c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$;
var $n_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = (void 0);
var $m_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = (function() {
  if ((!$n_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$)) {
    $n_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$ = new $c_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$().init___()
  };
  return $n_Lnet_devsupport_middleware_groups_websocket_api_SubscribeAck$
});
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function() {
  $c_O.call(this);
  this.group$1 = null
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype = new $h_O();
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.productPrefix__T = (function() {
  return "Unsubscribe"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe(x$1)) {
    var Unsubscribe$1 = $as_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe(x$1);
    return (this.group$1 === Unsubscribe$1.group$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.group$1;
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.init___T = (function(group) {
  this.group$1 = group;
  return this
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe)))
});
var $as_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function(obj) {
  return (($is_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.middleware.groups.websocket.api.Unsubscribe"))
});
var $isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe)))
});
var $asArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.middleware.groups.websocket.api.Unsubscribe;", depth))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe: 0
}, false, "net.devsupport.middleware.groups.websocket.api.Unsubscribe", {
  Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe;
/** @constructor */
var $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype.constructor = $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$;
/** @constructor */
var $h_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype = $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype;
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype.apply__O__O = (function(v1) {
  var group = $as_T(v1);
  return new $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe().init___T(group)
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype.toString__T = (function() {
  return "Unsubscribe"
});
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype.unapply__Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe__s_Option = (function(x$0) {
  return ((x$0 === null) ? $m_s_None$() : new $c_s_Some().init___O(x$0.group$1))
});
var $d_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = new $ClassTypeData({
  Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$: 0
...
$c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$.prototype.$classData = $d_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$;
var $n_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = (void 0);
var $m_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = (function() {
  if ((!$n_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$)) {
    $n_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$ = new $c_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$().init___()
  };
  return $n_Lnet_devsupport_middleware_groups_websocket_api_Unsubscribe$
});
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1 = (function() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.msg$2$f = null
});
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype = new $h_sr_AbstractFunction1();
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1 = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype = $c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype;
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype.apply__O__O = (function(v1) {
  return this.apply__T__Lnet_devsupport_messaging_serialization_util_ParsingResult($as_T(v1))
});
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype.apply__T__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(typeHint) {
  var x1 = this.$$outer$2.classMap$1.get__O__s_Option(typeHint);
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var x = $as_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(x2.x$2);
    var jsx$1 = new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(x)
  } else {
    var x$2 = $m_s_None$();
    if ((x$2 === x1)) {
      var jsx$1 = new $c_Lnet_devsupport_messaging_serialization_util_ParsingError().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["No SingleClassDeserializer found for ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([typeHint]))]))
    } else {
      var jsx$1;
      throw new $c_s_MatchError().init___O(x1)
    }
  ...
  var this$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingResult(jsx$1);
  if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$1)) {
    var x2$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$1);
    var v = x2$1.value$1;
    var dF = $as_Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(v);
    var this$2 = dF.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(this.msg$2$f));
    if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$2)) {
      var x2$2 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(this$2);
      var v$1 = x2$2.value$1;
      return new $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess().init___O(new $c_Lnet_devsupport_messaging_Envelope().init___O__Lnet_devsupport_messaging_Header(v$1, $m_Lnet_devsupport_serialization_macros_impl_SerializationMacros$().extractHeader__sci_Map__Lnet_devsupport_messaging_Header(this.msg$2$f)))
    } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(this$2)) {
      var x3 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(this$2);
      return x3
    } else {
      throw new $c_s_MatchError().init___O(this$2)
    }
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(this$1)) {
    var x3$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(this$1);
    return x3$1
  } else {
    throw new $c_s_MatchError().init___O(this$1)
  }
});
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype.init___Lnet_devsupport_serialization_macros_impl_MacroDeserializer__sci_Map = (function($$outer, msg$2) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1 = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1: 0
}, false, "net.devsupport.serialization.macros.impl.MacroDeserializer$$anonfun$deserialize$1", {
  Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_MacroDeserializer$$anonfun$deserialize$1;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_MsgPath = (function() {
  $c_O.call(this);
  this.path$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_MsgPath;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_MsgPath = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype = $c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype;
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.productPrefix__T = (function() {
  return "MsgPath"
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.read__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(d) {
  var this$1 = this.path$1;
  var path = $s_sc_TraversableOnce$class__mkString__sc_TraversableOnce__T__T__T__T(this$1, "", "/", "");
  return new $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$4().init___Lnet_devsupport_serialization_macros_impl_MsgPath__T__Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer(this, path, d)
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_serialization_macros_impl_MsgPath(x$1)) {
    var MsgPath$1 = $as_Lnet_devsupport_serialization_macros_impl_MsgPath(x$1);
    var x = this.path$1;
    var x$2 = MsgPath$1.path$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.path$1;
...
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.write__Lnet_devsupport_messaging_serialization_InternalSerializer__Lnet_devsupport_messaging_serialization_Serializer = (function(s) {
  var this$1 = this.path$1;
  var path = $s_sc_TraversableOnce$class__mkString__sc_TraversableOnce__T__T__T__T(this$1, "", "/", "");
  return new $c_Lnet_devsupport_serialization_macros_impl_MsgPath$$anon$1().init___Lnet_devsupport_serialization_macros_impl_MsgPath__T__Lnet_devsupport_messaging_serialization_InternalSerializer(this, path, s)
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.init___sci_List = (function(path) {
  this.path$1 = path;
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.$$bslash__T__Lnet_devsupport_serialization_macros_impl_MsgPath = (function(child) {
  var this$2 = this.path$1;
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  return new $c_Lnet_devsupport_serialization_macros_impl_MsgPath().init___sci_List($as_sci_List($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$2, child, bf)))
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_serialization_macros_impl_MsgPath = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_serialization_macros_impl_MsgPath)))
});
var $as_Lnet_devsupport_serialization_macros_impl_MsgPath = (function(obj) {
  return (($is_Lnet_devsupport_serialization_macros_impl_MsgPath(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.serialization.macros.impl.MsgPath"))
});
var $isArrayOf_Lnet_devsupport_serialization_macros_impl_MsgPath = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_serialization_macros_impl_MsgPath)))
});
var $asArrayOf_Lnet_devsupport_serialization_macros_impl_MsgPath = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_serialization_macros_impl_MsgPath(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.serialization.macros.impl.MsgPath;", depth))
});
var $d_Lnet_devsupport_serialization_macros_impl_MsgPath = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_MsgPath: 0
}, false, "net.devsupport.serialization.macros.impl.MsgPath", {
  Lnet_devsupport_serialization_macros_impl_MsgPath: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_MsgPath;
/** @constructor */
var $c_Lplay_api_libs_functional_$tilde = (function() {
  $c_O.call(this);
  this.$$und1$1 = null;
  this.$$und2$1 = null
});
$c_Lplay_api_libs_functional_$tilde.prototype = new $h_O();
$c_Lplay_api_libs_functional_$tilde.prototype.constructor = $c_Lplay_api_libs_functional_$tilde;
/** @constructor */
var $h_Lplay_api_libs_functional_$tilde = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_$tilde.prototype = $c_Lplay_api_libs_functional_$tilde.prototype;
$c_Lplay_api_libs_functional_$tilde.prototype.productPrefix__T = (function() {
  return "~"
});
$c_Lplay_api_libs_functional_$tilde.prototype.productArity__I = (function() {
  return 2
});
$c_Lplay_api_libs_functional_$tilde.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lplay_api_libs_functional_$tilde(x$1)) {
    var $$tilde$1 = $as_Lplay_api_libs_functional_$tilde(x$1);
...
$c_Lplay_api_libs_functional_$tilde.prototype.init___O__O = (function(_1, _2) {
  this.$$und1$1 = _1;
  this.$$und2$1 = _2;
  return this
});
$c_Lplay_api_libs_functional_$tilde.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.$$und1$1;
...
$c_Lplay_api_libs_functional_$tilde.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lplay_api_libs_functional_$tilde.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lplay_api_libs_functional_$tilde.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lplay_api_libs_functional_$tilde = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lplay_api_libs_functional_$tilde)))
});
var $as_Lplay_api_libs_functional_$tilde = (function(obj) {
  return (($is_Lplay_api_libs_functional_$tilde(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "play.api.libs.functional.$tilde"))
});
var $isArrayOf_Lplay_api_libs_functional_$tilde = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lplay_api_libs_functional_$tilde)))
});
var $asArrayOf_Lplay_api_libs_functional_$tilde = (function(obj, depth) {
  return (($isArrayOf_Lplay_api_libs_functional_$tilde(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lplay.api.libs.functional.$tilde;", depth))
});
var $d_Lplay_api_libs_functional_$tilde = new $ClassTypeData({
  Lplay_api_libs_functional_$tilde: 0
}, false, "play.api.libs.functional.$tilde", {
  Lplay_api_libs_functional_$tilde: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lplay_api_libs_functional_$tilde.prototype.$classData = $d_Lplay_api_libs_functional_$tilde;
/** @constructor */
var $c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1 = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype = new $h_sr_AbstractFunction1();
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype.constructor = $c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1;
/** @constructor */
var $h_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1 = (function() {
  /*<skip>*/
});
$h_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype = $c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype;
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype.apply__O__O = (function(v1) {
  return this.apply__O__F1(v1)
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype.init___Lplay_api_libs_functional_syntax_package$$anon$2 = (function($$outer) {
  return this
});
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype.apply__O__F1 = (function(a) {
  return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(a$1) {
    return (function(b$2) {
      return new $c_Lplay_api_libs_functional_$tilde().init___O__O(a$1, b$2)
    })
  })(a))
});
var $d_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1 = new $ClassTypeData({
  Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1: 0
}, false, "play.api.libs.functional.syntax.package$$anon$2$$anonfun$apply$1", {
  Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1.prototype.$classData = $d_Lplay_api_libs_functional_syntax_package$$anon$2$$anonfun$apply$1;
/** @constructor */
...
var $d_scm_HashTable$$anon$1 = new $ClassTypeData({
...
var $d_scm_Iterable$ = new $ClassTypeData({
  scm_Iterable$: 0
...
/** @constructor */
var $c_Lnet_devsupport_messaging_EmptyHeader$ = (function() {
  $c_Lnet_devsupport_messaging_Header.call(this)
});
$c_Lnet_devsupport_messaging_EmptyHeader$.prototype = new $h_Lnet_devsupport_messaging_Header();
$c_Lnet_devsupport_messaging_EmptyHeader$.prototype.constructor = $c_Lnet_devsupport_messaging_EmptyHeader$;
/** @constructor */
var $h_Lnet_devsupport_messaging_EmptyHeader$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_EmptyHeader$.prototype = $c_Lnet_devsupport_messaging_EmptyHeader$.prototype;
$c_Lnet_devsupport_messaging_EmptyHeader$.prototype.init___ = (function() {
  $c_Lnet_devsupport_messaging_Header.prototype.init___sci_Map.call(this, $m_sci_Map$EmptyMap$());
  $n_Lnet_devsupport_messaging_EmptyHeader$ = this;
  return this
});
var $d_Lnet_devsupport_messaging_EmptyHeader$ = new $ClassTypeData({
  Lnet_devsupport_messaging_EmptyHeader$: 0
}, false, "net.devsupport.messaging.EmptyHeader$", {
  Lnet_devsupport_messaging_EmptyHeader$: 1,
  Lnet_devsupport_messaging_Header: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lnet_devsupport_messaging_EmptyHeader$.prototype.$classData = $d_Lnet_devsupport_messaging_EmptyHeader$;
var $n_Lnet_devsupport_messaging_EmptyHeader$ = (void 0);
var $m_Lnet_devsupport_messaging_EmptyHeader$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_EmptyHeader$)) {
    $n_Lnet_devsupport_messaging_EmptyHeader$ = new $c_Lnet_devsupport_messaging_EmptyHeader$().init___()
  };
  return $n_Lnet_devsupport_messaging_EmptyHeader$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgArray = (function() {
  $c_O.call(this);
...
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgArray;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgArray = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_messaging_format_package$MsgArray.prototype = $c_Lnet_devsupport_messaging_format_package$MsgArray.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.productPrefix__T = (function() {
  this.value$1;
  return "MsgArray"
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.productArity__I = (function() {
  this.value$1;
  return 1
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.equals__O__Z = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgArray$().equals$extension__sc_Seq__O__Z(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.productElement__I__O = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgArray$().productElement$extension__sc_Seq__I__O(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.toString__T = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgArray$().toString$extension__sc_Seq__T(this.value$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.init___sc_Seq = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.hashCode__I = (function() {
  var $$this = this.value$1;
  return $$this.hashCode__I()
});
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.productIterator__sc_Iterator = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgArray$().productIterator$extension__sc_Seq__sc_Iterator(this.value$1)
});
var $is_Lnet_devsupport_messaging_format_package$MsgArray = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgArray)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgArray = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgArray(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgArray"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgArray = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgArray)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgArray = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgArray(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgArray;", depth))
});
var $d_Lnet_devsupport_messaging_format_package$MsgArray = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgArray: 0
}, false, "net.devsupport.messaging.format.package$MsgArray", {
  Lnet_devsupport_messaging_format_package$MsgArray: 1,
  O: 1,
  Lnet_devsupport_messaging_format_package$MsgValue: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
...
$c_Lnet_devsupport_messaging_format_package$MsgArray.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgArray;
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgFalse$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgFalse$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgFalse$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_format_package$MsgFalse$ = this;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.productPrefix__T = (function() {
  return "MsgFalse"
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.productArity__I = (function() {
  return 0
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.productElement__I__O = (function(x$1) {
  matchEnd3: {
    throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.toString__T = (function() {
  return "MsgFalse"
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.hashCode__I = (function() {
  return (-1242403262)
});
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lnet_devsupport_messaging_format_package$MsgFalse$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgFalse$: 0
}, false, "net.devsupport.messaging.format.package$MsgFalse$", {
  Lnet_devsupport_messaging_format_package$MsgFalse$: 1,
  O: 1,
  Lnet_devsupport_messaging_format_package$MsgValue: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgFalse$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgFalse$;
var $n_Lnet_devsupport_messaging_format_package$MsgFalse$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgFalse$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgFalse$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgFalse$ = new $c_Lnet_devsupport_messaging_format_package$MsgFalse$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgFalse$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgLong = (function() {
  $c_O.call(this);
...
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgLong;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgLong = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_messaging_format_package$MsgLong.prototype = $c_Lnet_devsupport_messaging_format_package$MsgLong.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.productPrefix__T = (function() {
  this.value$1;
  return "MsgLong"
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.productArity__I = (function() {
  this.value$1;
  return 1
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.init___J = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.equals__O__Z = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgLong$().equals$extension__J__O__Z(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.productElement__I__O = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgLong$().productElement$extension__J__I__O(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.toString__T = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgLong$().toString$extension__J__T(this.value$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.hashCode__I = (function() {
  var $$this = this.value$1;
  return $$this.$$up__sjsr_RuntimeLong__sjsr_RuntimeLong($$this.$$greater$greater$greater__I__sjsr_RuntimeLong(32)).toInt__I()
});
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.productIterator__sc_Iterator = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgLong$().productIterator$extension__J__sc_Iterator(this.value$1)
});
var $is_Lnet_devsupport_messaging_format_package$MsgLong = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgLong)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgLong = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgLong(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgLong"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgLong = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgLong)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgLong = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgLong(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgLong;", depth))
});
var $d_Lnet_devsupport_messaging_format_package$MsgLong = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgLong: 0
}, false, "net.devsupport.messaging.format.package$MsgLong", {
...
$c_Lnet_devsupport_messaging_format_package$MsgLong.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgLong;
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgNull$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgNull$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgNull$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgNull$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_format_package$MsgNull$ = this;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.productPrefix__T = (function() {
  return "MsgNull"
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.productArity__I = (function() {
  return 0
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.productElement__I__O = (function(x$1) {
  matchEnd3: {
    throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.toString__T = (function() {
  return "MsgNull"
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.hashCode__I = (function() {
  return (-1286745976)
});
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lnet_devsupport_messaging_format_package$MsgNull$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgNull$: 0
}, false, "net.devsupport.messaging.format.package$MsgNull$", {
  Lnet_devsupport_messaging_format_package$MsgNull$: 1,
  O: 1,
  Lnet_devsupport_messaging_format_package$MsgValue: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgNull$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgNull$;
var $n_Lnet_devsupport_messaging_format_package$MsgNull$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgNull$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgNull$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgNull$ = new $c_Lnet_devsupport_messaging_format_package$MsgNull$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgNull$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgNumber = (function() {
  $c_O.call(this);
...
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgNumber;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgNumber = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_messaging_format_package$MsgNumber.prototype = $c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.productPrefix__T = (function() {
  this.value$1;
  return "MsgNumber"
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.productArity__I = (function() {
  this.value$1;
  return 1
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.equals__O__Z = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgNumber$().equals$extension__D__O__Z(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.init___D = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.productElement__I__O = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgNumber$().productElement$extension__D__I__O(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.toString__T = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgNumber$().toString$extension__D__T(this.value$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.hashCode__I = (function() {
  var $$this = this.value$1;
  return $m_sjsr_Bits$().numberHashCode__D__I($$this)
});
$c_Lnet_devsupport_messaging_format_package$MsgNumber.prototype.productIterator__sc_Iterator = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgNumber$().productIterator$extension__D__sc_Iterator(this.value$1)
});
var $is_Lnet_devsupport_messaging_format_package$MsgNumber = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgNumber)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgNumber = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgNumber(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgNumber"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgNumber = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgNumber)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgNumber = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgNumber(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgNumber;", depth))
});
var $d_Lnet_devsupport_messaging_format_package$MsgNumber = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgNumber: 0
}, false, "net.devsupport.messaging.format.package$MsgNumber", {
...
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgObject;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgObject = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_messaging_format_package$MsgObject.prototype = $c_Lnet_devsupport_messaging_format_package$MsgObject.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.productPrefix__T = (function() {
  this.value$1;
  return "MsgObject"
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.productArity__I = (function() {
  this.value$1;
  return 1
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.equals__O__Z = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgObject$().equals$extension__sci_Map__O__Z(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.init___sci_Map = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.productElement__I__O = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgObject$().productElement$extension__sci_Map__I__O(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.toString__T = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgObject$().toString$extension__sci_Map__T(this.value$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.hashCode__I = (function() {
  var $$this = this.value$1;
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.unorderedHash__sc_TraversableOnce__I__I($$this, this$2.mapSeed$2)
});
$c_Lnet_devsupport_messaging_format_package$MsgObject.prototype.productIterator__sc_Iterator = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgObject$().productIterator$extension__sci_Map__sc_Iterator(this.value$1)
});
var $is_Lnet_devsupport_messaging_format_package$MsgObject = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgObject)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgObject = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgObject(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgObject"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgObject = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgObject)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgObject = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgObject(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgObject;", depth))
});
var $d_Lnet_devsupport_messaging_format_package$MsgObject = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgObject: 0
}, false, "net.devsupport.messaging.format.package$MsgObject", {
...
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgString;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgString = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_messaging_format_package$MsgString.prototype = $c_Lnet_devsupport_messaging_format_package$MsgString.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.productPrefix__T = (function() {
  this.value$1;
  return "MsgString"
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.productArity__I = (function() {
  this.value$1;
  return 1
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.equals__O__Z = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgString$().equals$extension__T__O__Z(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.productElement__I__O = (function(x$1) {
  return $m_Lnet_devsupport_messaging_format_package$MsgString$().productElement$extension__T__I__O(this.value$1, x$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.toString__T = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgString$().toString$extension__T__T(this.value$1)
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.init___T = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.hashCode__I = (function() {
  var $$this = this.value$1;
  return $m_sjsr_RuntimeString$().hashCode__T__I($$this)
});
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.productIterator__sc_Iterator = (function() {
  return $m_Lnet_devsupport_messaging_format_package$MsgString$().productIterator$extension__T__sc_Iterator(this.value$1)
});
var $is_Lnet_devsupport_messaging_format_package$MsgString = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_format_package$MsgString)))
});
var $as_Lnet_devsupport_messaging_format_package$MsgString = (function(obj) {
  return (($is_Lnet_devsupport_messaging_format_package$MsgString(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.format.package$MsgString"))
});
var $isArrayOf_Lnet_devsupport_messaging_format_package$MsgString = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_format_package$MsgString)))
});
var $asArrayOf_Lnet_devsupport_messaging_format_package$MsgString = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_format_package$MsgString(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.format.package$MsgString;", depth))
});
var $d_Lnet_devsupport_messaging_format_package$MsgString = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgString: 0
}, false, "net.devsupport.messaging.format.package$MsgString", {
...
$c_Lnet_devsupport_messaging_format_package$MsgString.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgString;
/** @constructor */
var $c_Lnet_devsupport_messaging_format_package$MsgTrue$ = (function() {
  $c_O.call(this)
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype = new $h_O();
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.constructor = $c_Lnet_devsupport_messaging_format_package$MsgTrue$;
/** @constructor */
var $h_Lnet_devsupport_messaging_format_package$MsgTrue$ = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype = $c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype;
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.init___ = (function() {
  $n_Lnet_devsupport_messaging_format_package$MsgTrue$ = this;
  return this
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.productPrefix__T = (function() {
  return "MsgTrue"
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.productArity__I = (function() {
  return 0
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.productElement__I__O = (function(x$1) {
  matchEnd3: {
    throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
  }
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.toString__T = (function() {
  return "MsgTrue"
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.hashCode__I = (function() {
  return (-1286569841)
});
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lnet_devsupport_messaging_format_package$MsgTrue$ = new $ClassTypeData({
  Lnet_devsupport_messaging_format_package$MsgTrue$: 0
}, false, "net.devsupport.messaging.format.package$MsgTrue$", {
  Lnet_devsupport_messaging_format_package$MsgTrue$: 1,
  O: 1,
  Lnet_devsupport_messaging_format_package$MsgValue: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lnet_devsupport_messaging_format_package$MsgTrue$.prototype.$classData = $d_Lnet_devsupport_messaging_format_package$MsgTrue$;
var $n_Lnet_devsupport_messaging_format_package$MsgTrue$ = (void 0);
var $m_Lnet_devsupport_messaging_format_package$MsgTrue$ = (function() {
  if ((!$n_Lnet_devsupport_messaging_format_package$MsgTrue$)) {
    $n_Lnet_devsupport_messaging_format_package$MsgTrue$ = new $c_Lnet_devsupport_messaging_format_package$MsgTrue$().init___()
  };
  return $n_Lnet_devsupport_messaging_format_package$MsgTrue$
});
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_util_ParsingError = (function() {
  $c_O.call(this);
  this.errors$1 = null
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_util_ParsingError;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_util_ParsingError = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype = $c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype;
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.productPrefix__T = (function() {
  return "ParsingError"
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingError(x$1)) {
    var ParsingError$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingError(x$1);
    var x = this.errors$1;
    var x$2 = ParsingError$1.errors$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
...
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.init___sc_Seq = (function(errors) {
  this.errors$1 = errors;
  return this
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_messaging_serialization_util_ParsingError = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingError)))
});
var $as_Lnet_devsupport_messaging_serialization_util_ParsingError = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_util_ParsingError(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.util.ParsingError"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingError = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingError)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingError = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingError(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.util.ParsingError;", depth))
});
var $d_Lnet_devsupport_messaging_serialization_util_ParsingError = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_util_ParsingError: 0
}, false, "net.devsupport.messaging.serialization.util.ParsingError", {
  Lnet_devsupport_messaging_serialization_util_ParsingError: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_util_ParsingResult: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingError.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_util_ParsingError;
/** @constructor */
var $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function() {
  $c_O.call(this);
  this.value$1 = null
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype = new $h_O();
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.constructor = $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess;
/** @constructor */
var $h_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype = $c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype;
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.productPrefix__T = (function() {
  return "ParsingSuccess"
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.productArity__I = (function() {
  return 1
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x$1)) {
    var ParsingSuccess$1 = $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(x$1);
    return $m_sr_BoxesRunTime$().equals__O__O__Z(this.value$1, ParsingSuccess$1.value$1)
  } else {
    return false
  }
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.value$1;
...
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.init___O = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingSuccess)))
});
var $as_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function(obj) {
  return (($is_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.devsupport.messaging.serialization.util.ParsingSuccess"))
});
var $isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_devsupport_messaging_serialization_util_ParsingSuccess)))
});
var $asArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = (function(obj, depth) {
  return (($isArrayOf_Lnet_devsupport_messaging_serialization_util_ParsingSuccess(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.devsupport.messaging.serialization.util.ParsingSuccess;", depth))
});
var $d_Lnet_devsupport_messaging_serialization_util_ParsingSuccess = new $ClassTypeData({
  Lnet_devsupport_messaging_serialization_util_ParsingSuccess: 0
}, false, "net.devsupport.messaging.serialization.util.ParsingSuccess", {
  Lnet_devsupport_messaging_serialization_util_ParsingSuccess: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_util_ParsingResult: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lnet_devsupport_messaging_serialization_util_ParsingSuccess.prototype.$classData = $d_Lnet_devsupport_messaging_serialization_util_ParsingSuccess;
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_MsgPath$ = (function() {
  $c_Lnet_devsupport_serialization_macros_impl_MsgPath.call(this)
});
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype = new $h_Lnet_devsupport_serialization_macros_impl_MsgPath();
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_MsgPath$ = (function() {
  /*<skip>*/
...
$h_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype = $c_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype;
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype.init___ = (function() {
  $c_Lnet_devsupport_serialization_macros_impl_MsgPath.prototype.init___sci_List.call(this, $m_sci_Nil$());
  $n_Lnet_devsupport_serialization_macros_impl_MsgPath$ = this;
  return this
});
var $d_Lnet_devsupport_serialization_macros_impl_MsgPath$ = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_MsgPath$: 0
...
$c_Lnet_devsupport_serialization_macros_impl_MsgPath$.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_MsgPath$;
var $n_Lnet_devsupport_serialization_macros_impl_MsgPath$ = (void 0);
var $m_Lnet_devsupport_serialization_macros_impl_MsgPath$ = (function() {
  if ((!$n_Lnet_devsupport_serialization_macros_impl_MsgPath$)) {
    $n_Lnet_devsupport_serialization_macros_impl_MsgPath$ = new $c_Lnet_devsupport_serialization_macros_impl_MsgPath$().init___()
  };
  return $n_Lnet_devsupport_serialization_macros_impl_MsgPath$
});
/** @constructor */
var $c_T2 = (function() {
  $c_O.call(this);
...
/** @constructor */
var $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator = (function() {
  $c_O.call(this);
  this.ser$1 = null;
  this.deser$1 = null
});
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype = new $h_O();
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.constructor = $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator;
/** @constructor */
var $h_Lnet_devsupport_serialization_macros_impl_FormatDelegator = (function() {
  /*<skip>*/
});
$h_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype = $c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype;
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.serialize__O__Lnet_devsupport_messaging_format_package$MsgValue = (function(obj) {
  return new $c_Lnet_devsupport_messaging_format_package$MsgObject().init___sci_Map(this.ser$1.serialize__O__sci_Map(obj))
});
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.init___Lnet_devsupport_messaging_serialization_Serializer__Lnet_devsupport_messaging_serialization_SingleClassDeserializer = (function(ser, deser) {
  this.ser$1 = ser;
  this.deser$1 = deser;
  return this
});
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult = (function(msg) {
  return this.deser$1.deserialize__Lnet_devsupport_messaging_format_package$MsgValue__Lnet_devsupport_messaging_serialization_util_ParsingResult(msg)
});
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.serialize__O__sci_Map = (function(obj) {
  return this.ser$1.serialize__O__sci_Map(obj)
});
var $d_Lnet_devsupport_serialization_macros_impl_FormatDelegator = new $ClassTypeData({
  Lnet_devsupport_serialization_macros_impl_FormatDelegator: 0
}, false, "net.devsupport.serialization.macros.impl.FormatDelegator", {
  Lnet_devsupport_serialization_macros_impl_FormatDelegator: 1,
  O: 1,
  Lnet_devsupport_messaging_serialization_Format: 1,
  Lnet_devsupport_messaging_serialization_InternalFormat: 1,
  Lnet_devsupport_messaging_serialization_InternalSerializer: 1,
  Lnet_devsupport_messaging_serialization_InternalSingleClassDeserializer: 1,
  Lnet_devsupport_messaging_serialization_Serializer: 1,
  Lnet_devsupport_messaging_serialization_SingleClassDeserializer: 1
});
$c_Lnet_devsupport_serialization_macros_impl_FormatDelegator.prototype.$classData = $d_Lnet_devsupport_serialization_macros_impl_FormatDelegator;
/** @constructor */
...
var $d_sc_MapLike$MappedValues = new $ClassTypeData({
...
$c_sci_ListMap.prototype.$$plus$plus__sc_GenTraversableOnce__sci_ListMap = (function(xs) {
  return $as_sci_ListMap(xs.seq__sc_TraversableOnce().$$div$colon__O__F2__O(this, new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(this$2) {
    return (function(x$2$2, x$3$2) {
...
$c_sjs_js_WrappedDictionary.prototype.$$plus__T2__sc_GenMap = (function(kv) {
  ...
  return $as_scm_Map($as_scm_Map($s_scg_Growable$class__$$plus$plus$eq__scg_Growable__sc_TraversableOnce__scg_Growable(this$1, this)).$$plus$eq__T2__scm_MapLike(kv))
});
var $d_sjs_js_WrappedDictionary = new $ClassTypeData({
...
var $d_scm_HashMap = new $ClassTypeData({
  scm_HashMap: 0
...
//# sourceMappingURL=js-framework-fastopt.js.map
